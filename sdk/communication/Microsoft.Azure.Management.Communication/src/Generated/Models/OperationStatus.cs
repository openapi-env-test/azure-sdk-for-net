...
namespace Microsoft.Azure.Management.Communication.Models
{
    ...
    public partial class OperationStatus
    {
        ...
        public OperationStatus(string id = default(string), string status = default(string), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), double? percentComplete = default(double?), ErrorDetail error = default(ErrorDetail))
        {
            Id = id;
            Status = status;
            StartTime = startTime;
