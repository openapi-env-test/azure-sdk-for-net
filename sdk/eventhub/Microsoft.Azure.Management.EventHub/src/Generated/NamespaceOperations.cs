...
namespace Microsoft.Azure.Management.EventHub
{
    ...
    /// </summary>
    internal partial class NamespaceOperations : IServiceOperations<EventHubManagementClient>, INamespaceOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal NamespaceOperations(EventHubManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> GetWithHttpMessagesAsync(string locationName, string operationResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.EventHub/locations/{locationName}/namespaceOperations/{operationResultId}").ToString();
