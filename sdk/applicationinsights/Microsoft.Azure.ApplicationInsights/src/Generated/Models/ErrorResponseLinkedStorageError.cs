...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ErrorResponseLinkedStorageError
        /// class.
        /// </summary>
        ...
        /// failed.</param>
        public ErrorResponseLinkedStorageError(string code = default(string), string message = default(string))
        {
            Code = code;
            Message = message;
            CustomInit();
