...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    public partial class OperationLive
    {
        ...
        public OperationLive(string name = default(string), bool? isDataAction = default(bool?), OperationInfo display = default(OperationInfo), string origin = default(string), object properties = default(object))
        {
            Name = name;
