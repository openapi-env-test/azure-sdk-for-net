# Azure Commerce Management client library for .NET
...
Install the Azure Commerce management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Commerce -Version 1.0.0-preview.1 
```
