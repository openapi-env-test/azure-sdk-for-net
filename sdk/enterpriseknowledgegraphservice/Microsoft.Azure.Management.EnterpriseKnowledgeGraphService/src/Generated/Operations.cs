...
namespace Microsoft.Azure.Management.EnterpriseKnowledgeGraphService
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureEnterpriseKnowledgeGraphServiceClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureEnterpriseKnowledgeGraphServiceClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationEntity>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.EnterpriseKnowledgeGraph/operations").ToString();
