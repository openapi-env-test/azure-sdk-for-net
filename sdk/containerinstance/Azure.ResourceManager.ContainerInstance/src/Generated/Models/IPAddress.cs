...
namespace Azure.ResourceManager.ContainerInstance.Models
{
    ...
    public partial class IPAddress
    {
        ...
        internal IPAddress(IList<Port> ports, ContainerGroupIPAddressType containerGroupIPAddressType, string ip, string dnsNameLabel, DnsNameLabelReusePolicy? autoGeneratedDomainNameLabelScope, string fqdn)
        {
            Ports = ports;
            ContainerGroupIPAddressType = containerGroupIPAddressType;
            IP = ip;
