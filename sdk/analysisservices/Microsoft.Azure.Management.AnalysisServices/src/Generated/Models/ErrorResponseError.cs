...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    public partial class ErrorResponseError
    {
        ...
        public ErrorResponseError(string code = default(string), string message = default(string), int? subCode = default(int?), int? httpStatusCode = default(int?), string timeStamp = default(string), IList<ErrorDetail> details = default(IList<ErrorDetail>))
        {
            Code = code;
            Message = message;
            SubCode = subCode;
