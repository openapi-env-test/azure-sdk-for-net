...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AssignmentReportProperties. </summary>
        ...
        internal AssignmentReportProperties(string startTime, string endTime, string lastModifiedTime, TimeSpan? duration, string assignmentReportPropertiesType, string status, string configurationProfile, IReadOnlyList<ReportResource> resources, ResponseError error, string reportFormatVersion)
        {
            StartTime = startTime;
            EndTime = endTime;
