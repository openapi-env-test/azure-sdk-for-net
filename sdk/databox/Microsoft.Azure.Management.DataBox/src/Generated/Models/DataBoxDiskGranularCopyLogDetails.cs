...
namespace Microsoft.Azure.Management.DataBox.Models
{
    ...
    public partial class DataBoxDiskGranularCopyLogDetails : GranularCopyLogDetails
    {
        ...
        public DataBoxDiskGranularCopyLogDetails(string serialNumber = default(string), string accountName = default(string), string errorLogLink = default(string), string verboseLogLink = default(string))
        {
