...
namespace Microsoft.Azure.Management.Security
{
    ...
    public static partial class SoftwareInventoriesOperationsExtensions
    {
            ...
            /// Test.
            /// </param>
            public static Software Get(this ISoftwareInventoriesOperations operations, string resourceGroupName, string resourceNamespace, string resourceType, string resourceName, string softwareName, string test)
            {
                return operations.GetAsync(resourceGroupName, resourceNamespace, resourceType, resourceName, softwareName, test).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Software> GetAsync(this ISoftwareInventoriesOperations operations, string resourceGroupName, string resourceNamespace, string resourceType, string resourceName, string softwareName, string test, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, resourceNamespace, resourceType, resourceName, softwareName, test, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
