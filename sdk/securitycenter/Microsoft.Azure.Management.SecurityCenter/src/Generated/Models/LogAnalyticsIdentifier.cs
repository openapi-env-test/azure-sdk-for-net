...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class LogAnalyticsIdentifier : ResourceIdentifier
    {
        ...
        public LogAnalyticsIdentifier(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string workspaceId = default(string), string workspaceSubscriptionId = default(string), string workspaceResourceGroup = default(string), string agentId = default(string))
