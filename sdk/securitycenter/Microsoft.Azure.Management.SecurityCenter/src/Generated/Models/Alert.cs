...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class Alert : Resource
    {
        ...
        /// detected. Possible Values: Informational, Low, Medium, and High.
        /// Learn more:
        ...
        /// <param name="resourceIdentifiers">The resource identifiers for this
        /// alert which can be used to direct the alert to the right product
        /// exposure group (tenant, workspace, subscription etc.). There can be
        /// multiple identifiers of different type per alert.</param>
        ...
        /// alert.</param>
        /// <param name="status">The life cycle status of the alert. Supported
        /// statuses are: Active, Resolved, Dismissed. Possible values include:
        /// 'Active', 'Resolved', 'Dismissed'</param>
        /// <param name="extendedLinks">Links related to the alert</param>
        /// <param name="alertUri">A direct link to the alert page in Azure
        /// Portal.</param>
        /// <param name="timeGenerated">The UTC time the alert was generated in
        ...
        /// <param name="processingEndTime">The UTC processing end time of the
        /// alert in ISO8601 format.</param>
        ...
        public Alert(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string alertType = default(string), string systemAlertId = default(string), string productComponentName = default(string), string alertDisplayName = default(string), string description = default(string), string severity = default(string), string intent = default(string), System.DateTime? startTimeUtc = default(System.DateTime?), System.DateTime? endTimeUtc = default(System.DateTime?), IList<ResourceIdentifier> resourceIdentifiers = default(IList<ResourceIdentifier>), IList<string> remediationSteps = default(IList<string>), string vendorName = default(string), string status = default(string), IList<IDictionary<string, object>> extendedLinks = default(IList<IDictionary<string, object>>), string alertUri = default(string), System.DateTime? timeGenerated = default(System.DateTime?), string productName = default(string), System.DateTime? processingEndTime = default(System.DateTime?), IList<AlertEntity> entities = default(IList<AlertEntity>), bool? isIncident = default(bool?), string correlationKey = default(string), IDictionary<string, object> extendedProperties = default(IDictionary<string, object>), string compromisedEntity = default(string))
            : base(id, name, type)
        {
        ...
        /// <summary>
        /// Gets the risk level of the threat that was detected. Possible
        /// Values: Informational, Low, Medium, and High. Learn more:
        /// https://docs.microsoft.com/en-us/azure/security-center/security-center-alerts-overview#how-are-alerts-classified.
        ...
        /// <summary>
        /// Gets the resource identifiers for this alert which can be used to
        /// direct the alert to the right product exposure group (tenant,
        /// workspace, subscription etc.). There can be multiple identifiers of
        /// different type per alert.
        /// </summary>
        ...
        /// <summary>
        /// Gets the life cycle status of the alert. Supported statuses are:
        /// Active, Resolved, Dismissed. Possible values include: 'Active',
        /// 'Resolved', 'Dismissed'
        /// </summary>
        ...
        public IList<IDictionary<string, object>> ExtendedLinks { get; private set; }
