...
namespace Microsoft.Azure.Management.DomainServices.Models
{
    ...
    public partial class DomainService : Resource
    {
        ...
        /// <param name="syncApplicationId">The unique sync application id of
        /// the Azure AD Domain Services deployment.</param>
        ...
        /// <summary>
        /// Gets the unique sync application id of the Azure AD Domain Services
        /// deployment.
        /// </summary>
        [JsonProperty(PropertyName = "properties.syncApplicationId")]
        public string SyncApplicationId { get; private set; }
