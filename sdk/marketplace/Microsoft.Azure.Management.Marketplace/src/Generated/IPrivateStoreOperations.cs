...
namespace Microsoft.Azure.Management.Marketplace
{
    ...
    public partial interface IPrivateStoreOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> CreateOrUpdateWithHttpMessagesAsync(string privateStoreId, PrivateStoreProperties payload = default(PrivateStoreProperties), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the list of available private stores
        /// </summary>
