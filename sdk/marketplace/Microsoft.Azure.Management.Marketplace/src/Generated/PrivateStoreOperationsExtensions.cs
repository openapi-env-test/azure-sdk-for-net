...
namespace Microsoft.Azure.Management.Marketplace
{
    ...
    public static partial class PrivateStoreOperationsExtensions
    {
            ...
            /// <param name='payload'>
            /// </param>
            public static void CreateOrUpdate(this IPrivateStoreOperations operations, string privateStoreId, PrivateStoreProperties payload = default(PrivateStoreProperties))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task CreateOrUpdateAsync(this IPrivateStoreOperations operations, string privateStoreId, PrivateStoreProperties payload = default(PrivateStoreProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
