...
namespace Microsoft.Azure.Management.Marketplace
{
    ...
    public partial interface IPrivateStoreOfferOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Offer>> CreateOrUpdateWithHttpMessagesAsync(string privateStoreId, string offerId, OfferProperties payload = default(OfferProperties), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
