...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    public partial class LegacyChargeSummary : ChargeSummary
    {
        ...
        public LegacyChargeSummary(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string billingPeriodId = default(string), string usageStart = default(string), string usageEnd = default(string), decimal? azureCharges = default(decimal?), decimal? chargesBilledSeparately = default(decimal?), decimal? marketplaceCharges = default(decimal?), string currency = default(string))
