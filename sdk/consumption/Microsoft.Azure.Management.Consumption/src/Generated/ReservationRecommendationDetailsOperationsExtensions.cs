...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public static partial class ReservationRecommendationDetailsOperationsExtensions
    {
            ...
            /// </param>
            public static ReservationRecommendationDetailsModel Get(this IReservationRecommendationDetailsOperations operations, string scope, string region, string term, string lookBackPeriod, string product)
            {
                return operations.GetAsync(scope, region, term, lookBackPeriod, product).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<ReservationRecommendationDetailsModel> GetAsync(this IReservationRecommendationDetailsOperations operations, string scope, string region, string term, string lookBackPeriod, string product, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(scope, region, term, lookBackPeriod, product, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
