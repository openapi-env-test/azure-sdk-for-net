...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public partial interface IReservationRecommendationDetailsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<ReservationRecommendationDetailsModel>> GetWithHttpMessagesAsync(string scope, string region, string term, string lookBackPeriod, string product, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
