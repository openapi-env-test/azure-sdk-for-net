...
namespace Microsoft.Azure.Management.Relay.Models
{
    ...
    public partial class NetworkRuleSet : Resource
    {
        ...
        public NetworkRuleSet(string id = default(string), string name = default(string), string type = default(string), string defaultAction = default(string), IList<NWRuleSetIpRules> ipRules = default(IList<NWRuleSetIpRules>))
            : base(id, name, type)
        {
