...
namespace Microsoft.Azure.Management.IoTSpaces.Models
{
    ...
    public partial class OperationDisplay
    {
        ...
        /// <param name="resourcetest">Resource Type: IoTSpaces</param>
        /// <param name="operation">Name of the operation</param>
        /// <param name="description">Friendly description for the
        /// operation,</param>
        public OperationDisplay(string provider = default(string), string resource = default(string), string resourcetest = default(string), string operation = default(string), string description = default(string))
        {
            Provider = provider;
            Resource = resource;
        ...
        /// Gets resource Type: IoTSpaces
        /// </summary>
        [JsonProperty(PropertyName = "resourcetest")]
        public string Resourcetest { get; private set; }
