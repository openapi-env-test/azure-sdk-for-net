...
#pragma warning disable SA1649 // File name should match first type name
    internal class CognitivesearchArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of CognitivesearchArmOperation for mocking. </summary>
        protected CognitivesearchArmOperation()
        {
        }

        internal CognitivesearchArmOperation(Response<T> response)
        {
            _operation = OperationInternal<T>.Succeeded(response.GetRawResponse(), response.Value);
        }

        internal CognitivesearchArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(nextLinkOperation, clientDiagnostics, response, "CognitivesearchArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
