...
#pragma warning disable SA1649 // File name should match first type name
    internal class CognitivesearchArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal CognitivesearchArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal CognitivesearchArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "CognitivesearchArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
