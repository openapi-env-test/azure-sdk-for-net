...
namespace Azure.ResourceManager.Cognitivesearch.Models
{
    ...
    public partial class Capacity
    {
        ...
        /// <param name="minVCores"> The minimum number of vCores that the index will consume. Represented with discrete values: 0.2, 0.5. 1, 2, 3, … to 16. </param>
        /// <param name="maxVCores"> The maximum number of vCores that the index can consume. Represented with discrete values: 0.2, 0.5. 1, 2, 3, … to 16. </param>
        ...
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="autoPause"/> is null. </exception>
        public Capacity(float minVCores, float maxVCores, Pause autoPause)
        {
            Argument.AssertNotNull(autoPause, nameof(autoPause));
