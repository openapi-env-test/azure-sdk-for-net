...
namespace Azure.ResourceManager.AgFoodPlatform
{
    ...
    public partial class SolutionCollection : ArmCollection, IEnumerable<SolutionResource>, IAsyncEnumerable<SolutionResource>
    {
        ...
        public virtual async Task<ArmOperation<SolutionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SolutionCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _solutionRestClient.CreateOrUpdateAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<SolutionResource> CreateOrUpdate(WaitUntil waitUntil, SolutionCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = _solutionRestClient.CreateOrUpdate(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, content, cancellationToken);
                var operation = new AgFoodPlatformArmOperation<SolutionResource>(Response.FromValue(new SolutionResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<SolutionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _solutionRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SolutionResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SolutionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _solutionRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionRestClient.Get(Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
