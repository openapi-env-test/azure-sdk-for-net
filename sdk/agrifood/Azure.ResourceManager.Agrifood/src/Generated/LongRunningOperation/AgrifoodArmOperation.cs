...
#pragma warning disable SA1649 // File name should match first type name
    internal class AgrifoodArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal AgrifoodArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal AgrifoodArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "AgrifoodArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
