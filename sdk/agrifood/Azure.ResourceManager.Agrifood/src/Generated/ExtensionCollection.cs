...
namespace Azure.ResourceManager.Agrifood
{
    ...
    public partial class ExtensionCollection : ArmCollection, IEnumerable<ExtensionResource>, IAsyncEnumerable<ExtensionResource>
    {
        ...
        {
            _extensionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Agrifood", ExtensionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ExtensionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string extensionId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AgrifoodArmOperation<ExtensionResource>(Response.FromValue(new ExtensionResource(Client, response), response.GetRawResponse()));
