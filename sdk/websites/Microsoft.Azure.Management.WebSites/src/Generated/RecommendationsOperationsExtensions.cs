...
namespace Microsoft.Azure.Management.WebSites
{
    ...
    public static partial class RecommendationsOperationsExtensions
    {
            ...
            {
                return operations.GetRecommendationBySubscriptionAsync(featured, filter).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.GetRuleDetailsBySiteNameAsync(resourceGroupName, siteName, name).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.GetRecommendedRulesForSiteAsync(resourceGroupName, siteName, featured, siteSku, numSlots).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.GetRecommendationHistoryForSiteAsync(resourceGroupName, siteName, startTime, endTime).GetAwaiter().GetResult();
            }
