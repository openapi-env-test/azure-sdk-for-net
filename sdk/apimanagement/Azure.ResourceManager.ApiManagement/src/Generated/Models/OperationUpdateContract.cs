...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class OperationUpdateContract
    {
        ...
        internal OperationUpdateContract(IList<ParameterContract> templateParameters, string description, RequestContract request, IList<ResponseContract> responses, string policies, string displayName, string method, string uriTemplate)
        {
