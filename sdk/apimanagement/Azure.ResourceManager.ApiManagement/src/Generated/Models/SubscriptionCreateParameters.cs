...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="SubscriptionCreateParameters"/>. </summary>
        ...
        internal SubscriptionCreateParameters(string ownerId, string scope, string displayName, string primaryKey, string secondaryKey, SubscriptionState? state, bool? allowTracing)
        {
            OwnerId = ownerId;
            Scope = scope;
