...
{
    public partial class FailureStatusCodeRange : IUtf8JsonSerializable
    {
        ...
        internal static FailureStatusCodeRange DeserializeFailureStatusCodeRange(JsonElement element)
        {
            ...
            return new FailureStatusCodeRange(Optional.ToNullable(min), Optional.ToNullable(max));
        }
    }
}
