...
{
    public partial class NamedValueCreateContract : IUtf8JsonSerializable
    {
        ...
        internal static NamedValueCreateContract DeserializeNamedValueCreateContract(JsonElement element)
        {
            ...
            return new NamedValueCreateContract(id, name, type, systemData.Value, Optional.ToList(tags), Optional.ToNullable(secret), displayName.Value, value.Value, keyVault.Value);
        }
    }
}
