...
{
    public partial class AllPoliciesContract : IUtf8JsonSerializable
    {
        ...
        internal static AllPoliciesContract DeserializeAllPoliciesContract(JsonElement element)
        {
            ...
            Optional<string> referencePolicyId = default;
            ...
            return new AllPoliciesContract(id, name, type, systemData.Value, referencePolicyId.Value, Optional.ToNullable(complianceState));
        }
    }
}
