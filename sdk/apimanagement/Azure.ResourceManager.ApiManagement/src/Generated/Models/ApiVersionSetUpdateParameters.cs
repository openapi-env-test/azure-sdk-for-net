...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiVersionSetUpdateParameters
    {
        ...
        internal ApiVersionSetUpdateParameters(string description, string versionQueryName, string versionHeaderName, string displayName, VersioningScheme? versioningScheme)
        {
