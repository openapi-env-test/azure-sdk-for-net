...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class SubscriptionUpdateParameters
    {
        ...
        internal SubscriptionUpdateParameters(string ownerId, string scope, DateTimeOffset? expireOn, string displayName, string primaryKey, string secondaryKey, SubscriptionState? state, string stateComment, bool? allowTracing)
        {
            OwnerId = ownerId;
            Scope = scope;
            ExpireOn = expireOn;
