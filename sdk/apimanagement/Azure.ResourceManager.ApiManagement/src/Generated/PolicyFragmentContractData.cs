...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PolicyFragmentContractData : ResourceData
    {
        ...
        internal PolicyFragmentContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string value, string description, PolicyFragmentContentFormat? format, string provisioningState) : base(id, name, resourceType, systemData)
        {
            Value = value;
