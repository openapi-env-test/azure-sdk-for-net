...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource"/> using the GetServiceGroup method.
    /// </summary>
    public partial class ServiceGroupResource : ArmResource
    {
        ...
        internal ServiceGroupResource(ArmClient client, ApiManagementGroupData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _serviceGroupGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string serviceGroupGroupApiVersion);
        ...
        {
            using var scope = _serviceGroupGroupClientDiagnostics.CreateScope("ServiceGroupResource.Get");
            scope.Start();
            try
            {
                var response = await _serviceGroupGroupRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServiceGroupResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceGroupGroupRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceGroupResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _serviceGroupGroupClientDiagnostics.CreateScope("ServiceGroupResource.Delete");
            scope.Start();
            try
            {
                var response = await _serviceGroupGroupRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, ETag ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceGroupGroupRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual AsyncPageable<ApiManagementGroupUserData> GetGroupUsersAsync(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ApiManagementGroupUserData.DeserializeApiManagementGroupUserData, _groupUserClientDiagnostics, Pipeline, "ServiceGroupResource.GetGroupUsers", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ApiManagementGroupUserData> GetGroupUsers(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _groupUserRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _groupUserRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ApiManagementGroupUserData.DeserializeApiManagementGroupUserData, _groupUserClientDiagnostics, Pipeline, "ServiceGroupResource.GetGroupUsers", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> CheckGroupUserEntityExistsAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _groupUserClientDiagnostics.CreateScope("ServiceGroupResource.CheckGroupUserEntityExists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ApiManagementGroupUserData>> CreateGroupUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _groupUserClientDiagnostics.CreateScope("ServiceGroupResource.CreateGroupUser");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteGroupUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _groupUserClientDiagnostics.CreateScope("ServiceGroupResource.DeleteGroupUser");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _serviceGroupGroupClientDiagnostics.CreateScope("ServiceGroupResource.GetEntityTag");
            scope.Start();
            try
            {
                var response = await _serviceGroupGroupRestClient.GetEntityTagAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> GetEntityTag(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceGroupGroupRestClient.GetEntityTag(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
