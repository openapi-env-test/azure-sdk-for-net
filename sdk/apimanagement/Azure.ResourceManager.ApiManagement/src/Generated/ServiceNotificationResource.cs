...
{
    /// <summary>
    /// A Class representing a ServiceNotification along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ServiceNotificationResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetServiceNotificationResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource"/> using the GetServiceNotification method.
    /// </summary>
    public partial class ServiceNotificationResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="ServiceNotificationResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceNotificationResource"/> class for mocking. </summary>
        protected ServiceNotificationResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceNotificationResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ServiceNotificationResource(ArmClient client, ApiManagementNotificationData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServiceNotificationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _serviceNotificationNotificationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string serviceNotificationNotificationApiVersion);
        ...
        public virtual async Task<Response<ServiceNotificationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _serviceNotificationNotificationClientDiagnostics.CreateScope("ServiceNotificationResource.Get");
            scope.Start();
            try
            {
                var response = await _serviceNotificationNotificationRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ServiceNotificationResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _serviceNotificationNotificationClientDiagnostics.CreateScope("ServiceNotificationResource.Get");
            scope.Start();
            try
            {
                var response = _serviceNotificationNotificationRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceNotificationResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<ServiceNotificationResource>> UpdateAsync(WaitUntil waitUntil, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _serviceNotificationNotificationClientDiagnostics.CreateScope("ServiceNotificationResource.Update");
            scope.Start();
            try
            {
                var response = await _serviceNotificationNotificationRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new ApiManagementArmOperation<ServiceNotificationResource>(Response.FromValue(new ServiceNotificationResource(Client, response), response.GetRawResponse()));
        ...
        /// <param name="ifMatch"> ETag of the Entity. Not required when creating an entity, but required when updating an entity. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<ServiceNotificationResource> Update(WaitUntil waitUntil, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _serviceNotificationNotificationClientDiagnostics.CreateScope("ServiceNotificationResource.Update");
            scope.Start();
            try
            {
                var response = _serviceNotificationNotificationRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<ServiceNotificationResource>(Response.FromValue(new ServiceNotificationResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual AsyncPageable<RecipientUserContract> GetNotificationRecipientUsersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, RecipientUserContract.DeserializeRecipientUserContract, _notificationRecipientUserClientDiagnostics, Pipeline, "ServiceNotificationResource.GetNotificationRecipientUsers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _notificationRecipientUserRestClient.CreateListByNotificationRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, RecipientUserContract.DeserializeRecipientUserContract, _notificationRecipientUserClientDiagnostics, Pipeline, "ServiceNotificationResource.GetNotificationRecipientUsers", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> CheckNotificationRecipientUserEntityExistsAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("ServiceNotificationResource.CheckNotificationRecipientUserEntityExists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<RecipientUserContract>> CreateOrUpdateNotificationRecipientUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("ServiceNotificationResource.CreateOrUpdateNotificationRecipientUser");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteNotificationRecipientUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("ServiceNotificationResource.DeleteNotificationRecipientUser");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<RecipientEmailContract> GetNotificationRecipientEmailsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, RecipientEmailContract.DeserializeRecipientEmailContract, _notificationRecipientEmailClientDiagnostics, Pipeline, "ServiceNotificationResource.GetNotificationRecipientEmails", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _notificationRecipientEmailRestClient.CreateListByNotificationRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, RecipientEmailContract.DeserializeRecipientEmailContract, _notificationRecipientEmailClientDiagnostics, Pipeline, "ServiceNotificationResource.GetNotificationRecipientEmails", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> CheckNotificationRecipientEmailEntityExistsAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("ServiceNotificationResource.CheckNotificationRecipientEmailEntityExists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<RecipientEmailContract>> CreateOrUpdateNotificationRecipientEmailAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("ServiceNotificationResource.CreateOrUpdateNotificationRecipientEmail");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteNotificationRecipientEmailAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("ServiceNotificationResource.DeleteNotificationRecipientEmail");
            scope.Start();
            try
            {
