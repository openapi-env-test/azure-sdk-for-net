...
namespace Azure.ResourceManager.ApiManagement.Samples
{
    public partial class Sample_ServiceGroupCollection
    {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementListGroups.json
            ...
            ServiceGroupCollection collection = apiManagementService.GetServiceGroups();

            // invoke the operation and iterate over the result
            await foreach (ServiceGroupResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_ApiManagementGetGroup()
        {
            ...
            ServiceGroupResource result = await collection.GetAsync(groupId);
        ...
        public async Task GetIfExists_ApiManagementGetGroup()
        {
            ...
            // invoke the operation
            string groupId = "59306a29e4bbd510dc24e5f9";
            NullableResponse<ServiceGroupResource> response = await collection.GetIfExistsAsync(groupId);
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementCreateGroup.json
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementCreateGroupExternal.json
            // this example is just showing the usage of "Group_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
