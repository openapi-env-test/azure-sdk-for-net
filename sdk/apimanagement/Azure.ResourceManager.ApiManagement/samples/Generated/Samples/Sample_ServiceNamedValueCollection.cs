...
{
    public partial class Sample_ServiceNamedValueCollection
    {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementListNamedValues.json
            ...
            ServiceNamedValueCollection collection = apiManagementService.GetServiceNamedValues();

            // invoke the operation and iterate over the result
            await foreach (ServiceNamedValueResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_ApiManagementGetNamedValue()
        {
            ...
            ServiceNamedValueResource result = await collection.GetAsync(namedValueId);
        ...
        public async Task GetIfExists_ApiManagementGetNamedValue()
        {
            ...
            // invoke the operation
            string namedValueId = "testarmTemplateproperties2";
            NullableResponse<ServiceNamedValueResource> response = await collection.GetIfExistsAsync(namedValueId);
            ServiceNamedValueResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementCreateNamedValue.json
...
"foo","bar"
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementCreateNamedValueWithKeyVault.json
            // this example is just showing the usage of "NamedValue_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
