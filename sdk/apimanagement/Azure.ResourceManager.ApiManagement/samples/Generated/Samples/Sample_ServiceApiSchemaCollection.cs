...
{
    public partial class Sample_ServiceApiSchemaCollection
    {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementListApiSchemas.json
            ...
            // get the collection of this ServiceApiSchemaResource
            ServiceApiSchemaCollection collection = serviceApi.GetServiceApiSchemas();

            // invoke the operation and iterate over the result
            await foreach (ServiceApiSchemaResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_ApiManagementGetApiSchema()
        {
            ...
            ServiceApiSchemaResource result = await collection.GetAsync(schemaId);
        ...
        public async Task GetIfExists_ApiManagementGetApiSchema()
        {
            ...
            // invoke the operation
            string schemaId = "ec12520d-9d48-4e7b-8f39-698ca2ac63f1";
            NullableResponse<ServiceApiSchemaResource> response = await collection.GetIfExistsAsync(schemaId);
            ServiceApiSchemaResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_ApiManagementCreateApiSchema()
        {
            ...
            ArmOperation<ServiceApiSchemaResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, schemaId, data);
