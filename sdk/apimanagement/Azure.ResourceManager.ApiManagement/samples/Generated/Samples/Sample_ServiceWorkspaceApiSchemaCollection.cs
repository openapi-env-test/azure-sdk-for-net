...
{
    public partial class Sample_ServiceWorkspaceApiSchemaCollection
    {
        // ApiManagementListWorkspaceApiSchemas
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_ApiManagementListWorkspaceApiSchemas()
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementListWorkspaceApiSchemas.json
            // this example is just showing the usage of "WorkspaceApiSchema_ListByApi" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (ServiceWorkspaceApiSchemaResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_ApiManagementGetWorkspaceApiSchema()
        {
            ...
            ServiceWorkspaceApiSchemaResource result = await collection.GetAsync(schemaId);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_ApiManagementGetWorkspaceApiSchema()
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementGetWorkspaceApiSchema.json
            // this example is just showing the usage of "WorkspaceApiSchema_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_ApiManagementGetWorkspaceApiSchema()
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementGetWorkspaceApiSchema.json
            // this example is just showing the usage of "WorkspaceApiSchema_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_ApiManagementCreateWorkspaceApiSchema()
        {
            ...
            ArmOperation<ServiceWorkspaceApiSchemaResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, schemaId, data);
