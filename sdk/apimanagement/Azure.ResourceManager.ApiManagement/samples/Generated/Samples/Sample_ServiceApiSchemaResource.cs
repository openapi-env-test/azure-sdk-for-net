...
{
    public partial class Sample_ServiceApiSchemaResource
    {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementHeadApiSchema.json
            ...
            // this example assumes you already have this ServiceApiSchemaResource created on azure
            // for more information of creating ServiceApiSchemaResource, please refer to the document of ServiceApiSchemaResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "rg1";
            string serviceName = "apimService1";
            string apiId = "57d1f7558aa04f15146d9d8a";
            string schemaId = "ec12520d-9d48-4e7b-8f39-698ca2ac63f1";
            ResourceIdentifier serviceApiSchemaResourceId = ServiceApiSchemaResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serviceName, apiId, schemaId);
            ServiceApiSchemaResource serviceApiSchema = client.GetServiceApiSchemaResource(serviceApiSchemaResourceId);

            // invoke the operation
            bool result = await serviceApiSchema.GetEntityTagAsync();
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementGetApiSchema.json
            ...
            // invoke the operation
            ServiceApiSchemaResource result = await serviceApiSchema.GetAsync();
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementCreateApiSchema.json
            ...
            ArmOperation<ServiceApiSchemaResource> lro = await serviceApiSchema.UpdateAsync(WaitUntil.Completed, data);
            ServiceApiSchemaResource result = lro.Value;
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementDeleteApiSchema.json
            ...
            await serviceApiSchema.DeleteAsync(WaitUntil.Completed, ifMatch);
