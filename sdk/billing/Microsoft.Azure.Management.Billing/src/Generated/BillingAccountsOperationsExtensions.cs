...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class BillingAccountsOperationsExtensions
    {
            ...
            /// </param>
            /// <param name='patch'>
            /// The payload that is used to patch the billing account.
            /// </param>
            public static BillingAccount Update(this IBillingAccountsOperations operations, string billingAccountName, IList<JsonPatchOperation> patch)
            {
                return operations.UpdateAsync(billingAccountName, patch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BillingAccount> UpdateAsync(this IBillingAccountsOperations operations, string billingAccountName, IList<JsonPatchOperation> patch, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateWithHttpMessagesAsync(billingAccountName, patch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The payload that is used to patch the billing account.
            /// </param>
            public static BillingAccount BeginUpdate(this IBillingAccountsOperations operations, string billingAccountName, IList<JsonPatchOperation> patch)
            {
                return operations.BeginUpdateAsync(billingAccountName, patch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BillingAccount> BeginUpdateAsync(this IBillingAccountsOperations operations, string billingAccountName, IList<JsonPatchOperation> patch, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginUpdateWithHttpMessagesAsync(billingAccountName, patch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
