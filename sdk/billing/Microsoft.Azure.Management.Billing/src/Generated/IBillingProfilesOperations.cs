...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public partial interface IBillingProfilesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<BillingProfile,BillingProfilesUpdateHeaders>> UpdateWithHttpMessagesAsync(string billingAccountName, string billingProfileName, IList<JsonPatchOperation> patch, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// The operation to create a BillingProfile.
        /// </summary>
        /// <param name='billingAccountName'>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<BillingProfile,BillingProfilesUpdateHeaders>> BeginUpdateWithHttpMessagesAsync(string billingAccountName, string billingProfileName, IList<JsonPatchOperation> patch, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
