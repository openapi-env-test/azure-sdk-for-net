...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class InvoiceSectionsOperationsExtensions
    {
            ...
            /// </param>
            /// <param name='patch'>
            /// The payload that is used to patch an invoice section.
            /// </param>
            public static InvoiceSection Update(this IInvoiceSectionsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, IList<JsonPatchOperation> patch)
            {
                return operations.UpdateAsync(billingAccountName, billingProfileName, invoiceSectionName, patch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<InvoiceSection> UpdateAsync(this IInvoiceSectionsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, IList<JsonPatchOperation> patch, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateWithHttpMessagesAsync(billingAccountName, billingProfileName, invoiceSectionName, patch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The payload that is used to patch an invoice section.
            /// </param>
            public static InvoiceSection BeginUpdate(this IInvoiceSectionsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, IList<JsonPatchOperation> patch)
            {
                return operations.BeginUpdateAsync(billingAccountName, billingProfileName, invoiceSectionName, patch).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<InvoiceSection> BeginUpdateAsync(this IInvoiceSectionsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, IList<JsonPatchOperation> patch, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginUpdateWithHttpMessagesAsync(billingAccountName, billingProfileName, invoiceSectionName, patch, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
