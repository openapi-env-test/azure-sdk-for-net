...
namespace Azure.ResourceManager.ContainerRegistry
{
    internal partial class SchedulesRestOperations
    {
        ...
        internal HttpMessage CreateScheduleRunRequest(Guid subscriptionId, string resourceGroupName, string registryName, ContainerRegistryRunContent content)
        {
        ...
        public async Task<Response> ScheduleRunAsync(Guid subscriptionId, string resourceGroupName, string registryName, ContainerRegistryRunContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="registryName"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceGroupName"/> or <paramref name="registryName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response ScheduleRun(Guid subscriptionId, string resourceGroupName, string registryName, ContainerRegistryRunContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(registryName, nameof(registryName));
            Argument.AssertNotNull(content, nameof(content));
