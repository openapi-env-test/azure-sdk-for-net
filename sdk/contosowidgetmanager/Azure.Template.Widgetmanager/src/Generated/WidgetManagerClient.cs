...
namespace Azure.Template.Widgetmanager
{
    ...
    public partial class WidgetManagerClient
    {
        ...
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidgetsAsync(Int32,Int32,Int32,RequestContext)']/*" />
        ...
        {
            return GetWidgetsImplementationAsync("WidgetManagerClient.GetWidgets", maxCount, skip, maxpagesize, context);
        }

        private AsyncPageable<BinaryData> GetWidgetsImplementationAsync(string diagnosticsScopeName, int? maxCount, int? skip, int? maxpagesize, RequestContext context)
        {
            ...
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
                        ? CreateGetWidgetsRequest(maxCount, skip, maxpagesize, context)
                        : CreateGetWidgetsNextPageRequest(nextLink, maxCount, skip, maxpagesize, context);
        ...
        /// <include file="Docs/WidgetManagerClient.xml" path="doc/members/member[@name='GetWidgets(Int32,Int32,Int32,RequestContext)']/*" />
        ...
        {
            return GetWidgetsImplementation("WidgetManagerClient.GetWidgets", maxCount, skip, maxpagesize, context);
        }

        private Pageable<BinaryData> GetWidgetsImplementation(string diagnosticsScopeName, int? maxCount, int? skip, int? maxpagesize, RequestContext context)
        {
