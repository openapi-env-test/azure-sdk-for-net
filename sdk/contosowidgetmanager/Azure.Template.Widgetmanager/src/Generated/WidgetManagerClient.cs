...
namespace Azure.Template.Widgetmanager
{
    ...
    public partial class WidgetManagerClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetWidgetsAsync(int? maxCount = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetWidgets(int? maxCount = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetWidgetsRequest(maxCount, skip, maxpagesize, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetWidgetsNextPageRequest(nextLink, maxCount, skip, maxpagesize, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "WidgetManagerClient.GetWidgets", "value", "nextLink", context);
        }
