...
namespace Microsoft.Azure.Management.ResourceGraph.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the GraphQueryError class.
        /// </summary>
        ...
        public GraphQueryError(string code = default(string), string message = default(string), IList<ErrorFieldContract> details = default(IList<ErrorFieldContract>))
        {
            Code = code;
            Message = message;
            Details = details;
