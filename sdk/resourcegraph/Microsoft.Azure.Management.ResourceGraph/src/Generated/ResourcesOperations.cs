...
namespace Microsoft.Azure.Management.ResourceGraph
{
    ...
    /// </summary>
    internal partial class ResourcesOperations : IServiceOperations<ResourceGraphClient>, IResourcesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ResourcesOperations(ResourceGraphClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<QueryResponse>> QueryWithHttpMessagesAsync(QueryRequest query, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<QueryResponse>(_responseContent, Client.DeserializationSettings);
                }
