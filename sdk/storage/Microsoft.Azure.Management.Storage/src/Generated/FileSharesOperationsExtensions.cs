...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public static partial class FileSharesOperationsExtensions
    {
            ...
            /// </param>
            public static void Restore(this IFileSharesOperations operations, string resourceGroupName, string accountName, string shareName, string deletedShareName = default(string), string deletedShareVersion = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task RestoreAsync(this IFileSharesOperations operations, string resourceGroupName, string accountName, string shareName, string deletedShareName = default(string), string deletedShareVersion = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
