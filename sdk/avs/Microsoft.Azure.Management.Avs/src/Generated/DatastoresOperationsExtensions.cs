...
namespace Microsoft.Azure.Management.Avs
{
    ...
    public static partial class DatastoresOperationsExtensions
    {
            ...
            /// </param>
            public static Datastore Create(this IDatastoresOperations operations, string resourceGroupName, string privateCloudName, string clusterName, string datastoreName, Datastore datastore)
            {
                return operations.CreateAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Datastore> CreateAsync(this IDatastoresOperations operations, string resourceGroupName, string privateCloudName, string clusterName, string datastoreName, Datastore datastore, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateWithHttpMessagesAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// A datastore in a private cloud cluster
            /// </param>
            public static Datastore BeginCreate(this IDatastoresOperations operations, string resourceGroupName, string privateCloudName, string clusterName, string datastoreName, Datastore datastore)
            {
                return operations.BeginCreateAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Datastore> BeginCreateAsync(this IDatastoresOperations operations, string resourceGroupName, string privateCloudName, string clusterName, string datastoreName, Datastore datastore, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginCreateWithHttpMessagesAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
