...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class FhirR4SampledData : FhirR4Element
    {
        ...
        internal FhirR4SampledData(string id, IReadOnlyList<FhirR4Extension> extension, FhirR4Quantity origin, double period, double? factor, double? lowerLimit, double? upperLimit, int dimensions, string data) : base(id, extension)
        {
            Origin = origin;
            Period = period;
            Factor = factor;
