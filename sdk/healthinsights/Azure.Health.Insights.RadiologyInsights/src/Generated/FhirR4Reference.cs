...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class FhirR4Reference : FhirR4Element
    {
        ...
        internal FhirR4Reference(string id, IReadOnlyList<FhirR4Extension> extension, string reference, string type, FhirR4Identifier identifier, string display) : base(id, extension)
        {
            Reference = reference;
            Type = type;
