...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class FhirR4Quantity : FhirR4Element
    {
        ...
        internal FhirR4Quantity(string id, IReadOnlyList<FhirR4Extension> extension, double? value, string comparator, string unit, string system, string code) : base(id, extension)
        {
            Value = value;
