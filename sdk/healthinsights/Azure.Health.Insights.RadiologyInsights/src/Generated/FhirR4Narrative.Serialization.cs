...
{
    internal partial class FhirR4Narrative : IUtf8JsonSerializable
    {
        ...
        internal static FhirR4Narrative DeserializeFhirR4Narrative(JsonElement element)
        {
            ...
            return new FhirR4Narrative(id.Value, Optional.ToList(extension), status, div);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static FhirR4Narrative FromResponse(Response response)
        {
