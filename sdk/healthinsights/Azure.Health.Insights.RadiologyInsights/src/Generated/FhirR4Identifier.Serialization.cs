...
{
    public partial class FhirR4Identifier : IUtf8JsonSerializable
    {
        ...
        internal static FhirR4Identifier DeserializeFhirR4Identifier(JsonElement element)
        {
            ...
            return new FhirR4Identifier(id.Value, Optional.ToList(extension), use.Value, type.Value, system.Value, value.Value, period.Value, assigner.Value);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static FhirR4Identifier FromResponse(Response response)
        {
