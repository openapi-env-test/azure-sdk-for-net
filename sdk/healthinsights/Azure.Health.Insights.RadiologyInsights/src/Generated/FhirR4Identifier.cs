...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class FhirR4Identifier : FhirR4Element
    {
        ...
        internal FhirR4Identifier(string id, IReadOnlyList<FhirR4Extension> extension, string use, FhirR4CodeableConcept type, string system, string value, FhirR4Period period, FhirR4Reference assigner) : base(id, extension)
        {
            Use = use;
            Type = type;
            System = system;
