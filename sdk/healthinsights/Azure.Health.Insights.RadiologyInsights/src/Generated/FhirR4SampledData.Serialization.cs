...
{
    public partial class FhirR4SampledData : IUtf8JsonSerializable
    {
        ...
        internal static FhirR4SampledData DeserializeFhirR4SampledData(JsonElement element)
        {
            ...
            Optional<double> factor = default;
            Optional<double> lowerLimit = default;
            Optional<double> upperLimit = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    origin = FhirR4Quantity.DeserializeFhirR4Quantity(property.Value);
                    continue;
                }
            ...
            return new FhirR4SampledData(id.Value, Optional.ToList(extension), origin, period, Optional.ToNullable(factor), Optional.ToNullable(lowerLimit), Optional.ToNullable(upperLimit), dimensions, data.Value);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static FhirR4SampledData FromResponse(Response response)
        {
