...
{
    public partial class FhirR4Period : IUtf8JsonSerializable
    {
        ...
        internal static FhirR4Period DeserializeFhirR4Period(JsonElement element)
        {
            ...
            return new FhirR4Period(id.Value, Optional.ToList(extension), start.Value, end.Value);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static FhirR4Period FromResponse(Response response)
        {
