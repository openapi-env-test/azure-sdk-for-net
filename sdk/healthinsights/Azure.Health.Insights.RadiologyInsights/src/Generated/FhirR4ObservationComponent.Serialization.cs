...
{
    internal partial class FhirR4ObservationComponent : IUtf8JsonSerializable
    {
        ...
        internal static FhirR4ObservationComponent DeserializeFhirR4ObservationComponent(JsonElement element)
        {
            ...
            return new FhirR4ObservationComponent(id.Value, Optional.ToList(extension), code, valueQuantity.Value, valueCodeableConcept.Value, valueString.Value, Optional.ToNullable(valueBoolean), Optional.ToNullable(valueInteger), valueRange.Value, valueRatio.Value, valueSampledData.Value, Optional.ToNullable(valueTime), valueDateTime.Value, valuePeriod.Value, valueReference.Value, dataAbsentReason.Value, Optional.ToList(interpretation), Optional.ToList(referenceRange));
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static FhirR4ObservationComponent FromResponse(Response response)
        {
