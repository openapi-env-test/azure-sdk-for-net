...
{
    internal partial class FhirR4Annotation : IUtf8JsonSerializable
    {
        ...
        internal static FhirR4Annotation DeserializeFhirR4Annotation(JsonElement element)
        {
            ...
            return new FhirR4Annotation(id.Value, Optional.ToList(extension), authorString.Value, time.Value, text);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static FhirR4Annotation FromResponse(Response response)
        {
