...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class PatientDetails
    {
        ...
        {
            ClinicalInfo = new ChangeTrackingList<IDictionary<string, BinaryData>>();
        }
        ...
        internal PatientDetails(PatientSex? sex, DateTimeOffset? birthDate, IList<IDictionary<string, BinaryData>> clinicalInfo)
        {
            Sex = sex;
            BirthDate = birthDate;
        ...
        public IList<IDictionary<string, BinaryData>> ClinicalInfo { get; }
    }
}
