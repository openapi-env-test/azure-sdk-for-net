...
{
    public partial class FhirR4Reference : IUtf8JsonSerializable
    {
        ...
        internal static FhirR4Reference DeserializeFhirR4Reference(JsonElement element)
        {
            ...
            Optional<FhirR4Identifier> identifier = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("identifier"u8))
                {
                    ...
                    identifier = FhirR4Identifier.DeserializeFhirR4Identifier(property.Value);
                    continue;
                }
            ...
            return new FhirR4Reference(id.Value, Optional.ToList(extension), reference.Value, type.Value, identifier.Value, display.Value);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static FhirR4Reference FromResponse(Response response)
        {
