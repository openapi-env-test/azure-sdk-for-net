      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_SignalRManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("SignalRService", "SignalRPrivateEndpointConnections", "2018-10-01"),
                new Tuple<string, string, string>("SignalRService", "SignalRPrivateLinkResources", "2018-10-01"),
