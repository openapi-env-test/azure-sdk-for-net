...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class IpAddressOrRange
    {
        ...
        /// Initializes a new instance of the IpAddressOrRange class.
        /// </summary>
        /// <param name="value">A single IPv4 address or a single IPv4 address
        /// range in CIDR format. Provided IPs must be well-formatted and
        /// cannot be contained in one of the following ranges: 10.0.0.0/8,
        ...
        /// “23.40.210.245” or “23.40.210.0/8”.</param>
        public IpAddressOrRange(string value = default(string))
        {
            Value = value;
            CustomInit();
        }
