...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public GremlinGraphCreateUpdateParameters(GremlinGraphResource resource)
        {
            if (resource == null)
            {
        ...
        internal GremlinGraphCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, GremlinGraphResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
