...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateUpdateParameters : ARMResourceProperties
    {
        ...
        internal MongoDBCollectionCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, MongoDBCollectionResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
