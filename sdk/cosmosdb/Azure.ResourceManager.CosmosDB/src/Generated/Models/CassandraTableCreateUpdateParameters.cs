...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraTableCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public CassandraTableCreateUpdateParameters(CassandraTableResource resource)
        {
            if (resource == null)
            {
        ...
        internal CassandraTableCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, CassandraTableResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
