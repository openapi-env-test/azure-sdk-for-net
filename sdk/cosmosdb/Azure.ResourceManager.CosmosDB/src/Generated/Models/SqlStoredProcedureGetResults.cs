...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlStoredProcedureGetResults : ARMResourceProperties
    {
        ...
        internal SqlStoredProcedureGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlStoredProcedureGetPropertiesResource resource) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
        }
