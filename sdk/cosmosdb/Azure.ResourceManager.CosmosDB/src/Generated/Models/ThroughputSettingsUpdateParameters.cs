...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ThroughputSettingsUpdateParameters : ARMResourceProperties
    {
        ...
        /// <param name="resource"> The standard JSON format of a resource throughput. </param>
        internal ThroughputSettingsUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, ThroughputSettingsResource resource) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
        }
