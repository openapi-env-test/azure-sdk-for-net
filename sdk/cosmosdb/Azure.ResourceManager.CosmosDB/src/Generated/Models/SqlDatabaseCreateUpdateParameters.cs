...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlDatabaseCreateUpdateParameters. </summary>
        /// <param name="resource"> The standard JSON format of a SQL database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlDatabaseCreateUpdateParameters(SqlDatabaseResource resource)
        {
            if (resource == null)
            {
        ...
        internal SqlDatabaseCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
