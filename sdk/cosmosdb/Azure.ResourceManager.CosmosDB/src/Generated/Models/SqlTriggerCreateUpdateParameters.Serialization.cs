...
{
    public partial class SqlTriggerCreateUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static SqlTriggerCreateUpdateParameters DeserializeSqlTriggerCreateUpdateParameters(JsonElement element)
        {
            ...
            return new SqlTriggerCreateUpdateParameters(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource, options.Value);
        }
    }
}
