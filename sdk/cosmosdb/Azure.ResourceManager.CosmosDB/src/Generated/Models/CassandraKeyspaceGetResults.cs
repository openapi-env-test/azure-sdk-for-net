...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CassandraKeyspaceGetResults. </summary>
        ...
        internal CassandraKeyspaceGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, CassandraKeyspaceGetPropertiesResource resource, CassandraKeyspaceGetPropertiesOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
