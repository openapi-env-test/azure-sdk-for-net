...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerCreateUpdateParameters : ARMResourceProperties
    {
        ...
        internal SqlContainerCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlContainerResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
