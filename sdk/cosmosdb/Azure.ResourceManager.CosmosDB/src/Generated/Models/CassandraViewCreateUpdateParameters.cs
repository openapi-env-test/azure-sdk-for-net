...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CassandraViewCreateUpdateParameters. </summary>
        ...
        internal CassandraViewCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, CassandraViewResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
