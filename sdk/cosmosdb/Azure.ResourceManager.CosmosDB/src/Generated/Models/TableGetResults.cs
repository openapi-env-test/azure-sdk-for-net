...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class TableGetResults : ARMResourceProperties
    {
        ...
        internal TableGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, TableGetPropertiesResource resource, TableGetPropertiesOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
