...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlUserDefinedFunctionCreateUpdateParameters : ARMResourceProperties
    {
        ...
        internal SqlUserDefinedFunctionCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlUserDefinedFunctionResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
