...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlContainerGetResults. </summary>
        ...
        internal SqlContainerGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlContainerGetPropertiesResource resource, SqlContainerGetPropertiesOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
