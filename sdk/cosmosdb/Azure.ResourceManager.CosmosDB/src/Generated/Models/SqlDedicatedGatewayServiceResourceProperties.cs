...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDedicatedGatewayServiceResourceProperties : ServiceResourceProperties
    {
        ...
        internal SqlDedicatedGatewayServiceResourceProperties(DateTimeOffset? creationTime, ServiceSize? instanceSize, int? instanceCount, ServiceType serviceType, ServiceStatus? status, IDictionary<string, object> additionalProperties, string sqlDedicatedGatewayEndpoint, IReadOnlyList<SqlDedicatedGatewayRegionalServiceResource> locations) : base(creationTime, instanceSize, instanceCount, serviceType, status, additionalProperties)
        {
