...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of GremlinGraphGetResults. </summary>
        ...
        internal GremlinGraphGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, GremlinGraphGetPropertiesResource resource, GremlinGraphGetPropertiesOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
