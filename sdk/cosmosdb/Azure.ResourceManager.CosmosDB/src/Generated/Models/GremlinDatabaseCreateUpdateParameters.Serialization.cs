...
{
    public partial class GremlinDatabaseCreateUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabaseCreateUpdateParameters DeserializeGremlinDatabaseCreateUpdateParameters(JsonElement element)
        {
            ...
            return new GremlinDatabaseCreateUpdateParameters(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource, options.Value);
        }
    }
}
