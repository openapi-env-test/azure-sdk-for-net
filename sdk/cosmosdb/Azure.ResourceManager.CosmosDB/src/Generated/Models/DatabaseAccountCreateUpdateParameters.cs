...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public DatabaseAccountCreateUpdateParameters(IEnumerable<Location> locations, CreateMode createMode)
        {
            if (locations == null)
            {
        ...
        internal DatabaseAccountCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, DatabaseAccountKind? kind, ConsistencyPolicy consistencyPolicy, IList<Location> locations, string databaseAccountOfferType, IList<IpAddressOrRange> ipRules, bool? isVirtualNetworkFilterEnabled, bool? enableAutomaticFailover, IList<Capability> capabilities, IList<VirtualNetworkRule> virtualNetworkRules, bool? enableMultipleWriteLocations, bool? enableCassandraConnector, ConnectorOffer? connectorOffer, bool? disableKeyBasedMetadataWriteAccess, string keyVaultKeyUri, string defaultIdentity, PublicNetworkAccess? publicNetworkAccess, bool? enableFreeTier, ApiProperties apiProperties, bool? enableAnalyticalStorage, AnalyticalStorageConfiguration analyticalStorageConfiguration, CreateMode createMode, BackupPolicy backupPolicy, IList<CorsPolicy> cors, NetworkAclBypass? networkAclBypass, IList<string> networkAclBypassResourceIds, DiagnosticLogSettings diagnosticLogSettings, bool? disableLocalAuth, RestoreParameters restoreParameters) : base(id, name, type, location, tags, identity)
        {
            Kind = kind;
