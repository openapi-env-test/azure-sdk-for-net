...
{
    public partial class CassandraKeyspaceGetResults : IUtf8JsonSerializable
    {
        ...
        internal static CassandraKeyspaceGetResults DeserializeCassandraKeyspaceGetResults(JsonElement element)
        {
            ...
            return new CassandraKeyspaceGetResults(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource.Value, options.Value);
        }
    }
}
