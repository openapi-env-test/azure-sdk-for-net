...
{
    public partial class GremlinGraphCreateUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphCreateUpdateParameters DeserializeGremlinGraphCreateUpdateParameters(JsonElement element)
        {
            ...
            return new GremlinGraphCreateUpdateParameters(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource, options.Value);
        }
    }
}
