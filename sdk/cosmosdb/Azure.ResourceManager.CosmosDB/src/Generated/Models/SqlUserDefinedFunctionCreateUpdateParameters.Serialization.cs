...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class SqlUserDefinedFunctionCreateUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static SqlUserDefinedFunctionCreateUpdateParameters DeserializeSqlUserDefinedFunctionCreateUpdateParameters(JsonElement element)
        {
            ...
            return new SqlUserDefinedFunctionCreateUpdateParameters(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource, options.Value);
        }
    }
}
