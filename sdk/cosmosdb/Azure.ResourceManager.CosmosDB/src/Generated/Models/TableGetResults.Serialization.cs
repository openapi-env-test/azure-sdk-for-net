...
{
    public partial class TableGetResults : IUtf8JsonSerializable
    {
        ...
        internal static TableGetResults DeserializeTableGetResults(JsonElement element)
        {
            ...
            return new TableGetResults(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource.Value, options.Value);
        }
    }
}
