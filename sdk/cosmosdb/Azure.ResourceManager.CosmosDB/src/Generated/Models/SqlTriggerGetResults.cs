...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlTriggerGetResults : ARMResourceProperties
    {
        ...
        internal SqlTriggerGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlTriggerGetPropertiesResource resource) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
        }
