...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlTriggerCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public SqlTriggerCreateUpdateParameters(SqlTriggerResource resource)
        {
            if (resource == null)
            {
        ...
        internal SqlTriggerCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlTriggerResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
