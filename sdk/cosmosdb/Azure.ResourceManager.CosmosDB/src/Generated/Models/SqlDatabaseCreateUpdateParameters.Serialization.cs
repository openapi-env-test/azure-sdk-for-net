...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class SqlDatabaseCreateUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseCreateUpdateParameters DeserializeSqlDatabaseCreateUpdateParameters(JsonElement element)
        {
            ...
            return new SqlDatabaseCreateUpdateParameters(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource, options.Value);
        }
    }
}
