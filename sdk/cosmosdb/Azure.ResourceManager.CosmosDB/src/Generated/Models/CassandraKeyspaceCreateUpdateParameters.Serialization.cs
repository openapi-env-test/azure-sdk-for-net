...
{
    public partial class CassandraKeyspaceCreateUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static CassandraKeyspaceCreateUpdateParameters DeserializeCassandraKeyspaceCreateUpdateParameters(JsonElement element)
        {
            ...
            return new CassandraKeyspaceCreateUpdateParameters(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource, options.Value);
        }
    }
}
