...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseGetResults : ARMResourceProperties
    {
        ...
        internal SqlDatabaseGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlDatabaseGetPropertiesResource resource, SqlDatabaseGetPropertiesOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
