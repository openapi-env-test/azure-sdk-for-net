...
{
    public partial class ThroughputSettingsGetResults : IUtf8JsonSerializable
    {
        ...
        internal static ThroughputSettingsGetResults DeserializeThroughputSettingsGetResults(JsonElement element)
        {
            ...
            return new ThroughputSettingsGetResults(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource.Value);
        }
    }
}
