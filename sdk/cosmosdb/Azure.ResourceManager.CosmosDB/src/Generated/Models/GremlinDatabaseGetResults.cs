...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of GremlinDatabaseGetResults. </summary>
        ...
        internal GremlinDatabaseGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, GremlinDatabaseGetPropertiesResource resource, GremlinDatabaseGetPropertiesOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
