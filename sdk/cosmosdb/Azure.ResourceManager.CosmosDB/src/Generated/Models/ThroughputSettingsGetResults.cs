...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ThroughputSettingsGetResults : ARMResourceProperties
    {
        ...
        internal ThroughputSettingsGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, ThroughputSettingsGetPropertiesResource resource) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
        }
