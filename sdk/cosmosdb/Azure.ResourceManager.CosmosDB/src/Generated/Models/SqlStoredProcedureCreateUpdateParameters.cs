...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlStoredProcedureCreateUpdateParameters. </summary>
        /// <param name="resource"> The standard JSON format of a storedProcedure. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlStoredProcedureCreateUpdateParameters(SqlStoredProcedureResource resource)
        {
            if (resource == null)
            {
        ...
        internal SqlStoredProcedureCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, SqlStoredProcedureResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
