...
{
    public partial class SqlStoredProcedureGetResults : IUtf8JsonSerializable
    {
        ...
        internal static SqlStoredProcedureGetResults DeserializeSqlStoredProcedureGetResults(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("resource"))
                        {
                            ...
                            resource = SqlStoredProcedureGetPropertiesResource.DeserializeSqlStoredProcedureGetPropertiesResource(property0.Value);
                            continue;
                        }
                    }
                    continue;
