...
{
    public partial class CassandraTableCreateUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static CassandraTableCreateUpdateParameters DeserializeCassandraTableCreateUpdateParameters(JsonElement element)
        {
            ...
            return new CassandraTableCreateUpdateParameters(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource, options.Value);
        }
    }
}
