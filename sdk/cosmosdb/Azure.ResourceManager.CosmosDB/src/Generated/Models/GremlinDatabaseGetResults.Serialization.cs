...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class GremlinDatabaseGetResults : IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabaseGetResults DeserializeGremlinDatabaseGetResults(JsonElement element)
        {
            ...
            return new GremlinDatabaseGetResults(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), identity.Value, resource.Value, options.Value);
        }
    }
}
