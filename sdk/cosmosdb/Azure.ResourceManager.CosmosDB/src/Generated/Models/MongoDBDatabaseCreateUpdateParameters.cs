...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBDatabaseCreateUpdateParameters : ARMResourceProperties
    {
        ...
        internal MongoDBDatabaseCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, MongoDBDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
