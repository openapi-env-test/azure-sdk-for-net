...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinDatabaseCreateUpdateParameters : ARMResourceProperties
    {
        ...
        internal GremlinDatabaseCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, GremlinDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags, identity)
        {
            Resource = resource;
            Options = options;
        }
