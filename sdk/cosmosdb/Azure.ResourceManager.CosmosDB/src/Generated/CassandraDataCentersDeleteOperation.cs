...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraDataCentersDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of CassandraDataCentersDeleteOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraDataCentersDeleteOperation");
        }
        /// <inheritdoc />
