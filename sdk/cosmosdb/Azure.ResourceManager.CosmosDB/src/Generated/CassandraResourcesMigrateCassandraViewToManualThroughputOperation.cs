...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraResourcesMigrateCassandraViewToManualThroughputOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of CassandraResourcesMigrateCassandraViewToManualThroughputOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraResourcesMigrateCassandraViewToManualThroughputOperation");
        }
        /// <inheritdoc />
