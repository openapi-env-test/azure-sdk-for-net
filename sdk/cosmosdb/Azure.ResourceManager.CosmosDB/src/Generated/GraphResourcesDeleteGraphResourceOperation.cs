...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GraphResourcesDeleteGraphResourceOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of GraphResourcesDeleteGraphResourceOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GraphResourcesDeleteGraphResourceOperation");
        }
        /// <inheritdoc />
