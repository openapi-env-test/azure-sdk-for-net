...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class PercentileOperations
    {
        ...
        internal PercentileOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-07-01-preview")
        {
            RestClient = new PercentileRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
