...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class TableResourcesOperations
    {
        ...
        internal TableResourcesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-07-01-preview")
        {
            RestClient = new TableResourcesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
