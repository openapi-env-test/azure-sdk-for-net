...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraClustersDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of CassandraClustersDeleteOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraClustersDeleteOperation");
        }
        /// <inheritdoc />
