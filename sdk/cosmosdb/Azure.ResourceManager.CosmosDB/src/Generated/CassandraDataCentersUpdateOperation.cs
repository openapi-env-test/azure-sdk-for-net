...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraDataCentersUpdateOperation : Operation<DataCenterResource>, IOperationSource<DataCenterResource>
    {
        private readonly ArmOperationHelpers<DataCenterResource> _operation;

        /// <summary> Initializes a new instance of CassandraDataCentersUpdateOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<DataCenterResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraDataCentersUpdateOperation");
        }
        /// <inheritdoc />
