...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraResourcesUpdateCassandraViewThroughputOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of CassandraResourcesUpdateCassandraViewThroughputOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraResourcesUpdateCassandraViewThroughputOperation");
        }
        /// <inheritdoc />
