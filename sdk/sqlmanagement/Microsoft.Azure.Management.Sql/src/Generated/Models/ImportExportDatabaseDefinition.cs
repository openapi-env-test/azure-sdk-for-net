...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    /// </summary>
    public partial class ImportExportDatabaseDefinition
    {
        /// <summary>
        /// Initializes a new instance of the ImportExportDatabaseDefinition
        /// class.
        /// </summary>
        ...
        public ImportExportDatabaseDefinition(string storageKeyType, string storageKey, string storageUri, string administratorLogin, string administratorLoginPassword, string databaseName = default(string), string edition = default(string), string serviceObjectiveName = default(string), string maxSizeBytes = default(string), string authenticationType = default(string))
        {
