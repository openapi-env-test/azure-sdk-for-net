...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ServerTableAuditingPolicy : ProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the ServerTableAuditingPolicy class.
        /// </summary>
        public ServerTableAuditingPolicy()
        {
            CustomInit();
        }
        ...
        /// endpoint.</param>
        public ServerTableAuditingPolicy(string id = default(string), string name = default(string), string type = default(string), string kind = default(string), string location = default(string), string auditingState = default(string), string auditLogsTableName = default(string), string eventTypesToAudit = default(string), string fullAuditLogsTableName = default(string), string retentionDays = default(string), string storageAccountKey = default(string), string storageAccountName = default(string), string storageAccountResourceGroupName = default(string), string storageAccountSecondaryKey = default(string), System.Guid? storageAccountSubscriptionId = default(System.Guid?), string storageTableEndpoint = default(string))
            : base(id, name, type)
        {
            Kind = kind;
            Location = location;
