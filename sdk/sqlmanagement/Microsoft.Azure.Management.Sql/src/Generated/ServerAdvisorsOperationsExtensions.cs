...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class ServerAdvisorsOperationsExtensions
    {
            ...
            /// </param>
            public static AdvisorListResult ListByServer(this IServerAdvisorsOperations operations, string resourceGroupName, string serverName)
            {
            ...
            /// </param>
            public static async Task<AdvisorListResult> ListByServerAsync(this IServerAdvisorsOperations operations, string resourceGroupName, string serverName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The requested advisor resource state.
            /// </param>
            public static Advisor CreateOrUpdate(this IServerAdvisorsOperations operations, string resourceGroupName, string serverName, string advisorName, Advisor parameters)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, serverName, advisorName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Advisor> CreateOrUpdateAsync(this IServerAdvisorsOperations operations, string resourceGroupName, string serverName, string advisorName, Advisor parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, serverName, advisorName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
