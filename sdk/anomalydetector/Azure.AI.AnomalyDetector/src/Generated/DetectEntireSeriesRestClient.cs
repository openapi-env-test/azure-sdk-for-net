...
{
    internal partial class DetectEntireSeriesRestClient
    {
        private string endpoint;
        private ClientDiagnostics _clientDiagnostics;
        private HttpPipeline _pipeline;

        /// <summary> Initializes a new instance of DetectEntireSeriesRestClient. </summary>
        ...
        public DetectEntireSeriesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint)
        {
            if (endpoint == null)
            {
        ...
        internal HttpMessage CreateTestRequest(DetectRequest body)
        {
        ...
        public async Task<Response<EntireDetectResponse>> TestAsync(DetectRequest body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
            ...
            using var message = CreateTestRequest(body);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public Response<EntireDetectResponse> Test(DetectRequest body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
