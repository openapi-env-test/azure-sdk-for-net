# Azure recoveryservicessiterecovery Management client library for .NET
...
Install the Azure recoveryservicessiterecovery management library for .NET with [NuGet](https://www.nuget.org/):
