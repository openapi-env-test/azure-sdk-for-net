namespace Azure.IoT.Demo
{
    public partial class DeviceManagementClient
    {
        ...
        public DeviceManagementClient(string endpoint, string instanceId, Azure.Core.TokenCredential credential, Azure.IoT.Demo.DeviceUpdateClientOptions options) { }
        ...
        public virtual Azure.Response StopDeploymentAAA(string groupId, string deviceClassId, string deploymentId, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> StopDeploymentAAAAsync(string groupId, string deviceClassId, string deploymentId, Azure.RequestContext context = null) { throw null; }
    ...
    public partial class DeviceUpdateClient
    {
        ...
        public DeviceUpdateClient(string endpoint, string instanceId, Azure.Core.TokenCredential credential, Azure.IoT.Demo.DeviceUpdateClientOptions options) { }
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
    ...
    {
        public DeviceUpdateClientOptions(Azure.IoT.Demo.DeviceUpdateClientOptions.ServiceVersion version = Azure.IoT.Demo.DeviceUpdateClientOptions.ServiceVersion.V2022_07_01_preview) { }
