...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class GalleryUpdate : UpdateResource
    {
        ...
        /// gallery.</param>
        public GalleryUpdate(IDictionary<string, string> tags = default(IDictionary<string, string>), string description = default(string), GalleryIdentifier identifier = default(GalleryIdentifier), string provisioningState = default(string))
            : base(tags)
        {
