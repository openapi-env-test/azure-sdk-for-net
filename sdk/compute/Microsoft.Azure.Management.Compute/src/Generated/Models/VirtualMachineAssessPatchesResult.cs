...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineAssessPatchesResult
    {
        ...
        /// complete installation but the reboot has not yet occurred. Possible
        ...
        /// update of this result object.</param>
        ...
        /// them.</param>
        public VirtualMachineAssessPatchesResult(string status = default(string), string assessmentActivityId = default(string), string rebootPending = default(string), int? criticalAndSecurityPatchCount = default(int?), int? otherPatchCount = default(int?), System.DateTime? startDateTime = default(System.DateTime?), System.DateTime? lastModifiedDateTime = default(System.DateTime?), IList<VirtualMachineSoftwarePatchProperties> patches = default(IList<VirtualMachineSoftwarePatchProperties>), ApiError error = default(ApiError))
        {
            Status = status;
        ...
        /// installation but the reboot has not yet occurred. Possible values
        /// include: 'true', 'false'
        /// </summary>
        [JsonProperty(PropertyName = "rebootPending")]
        public string RebootPending { get; private set; }
        ...
        /// <summary>
        /// Gets the UTC timestamp of the last update of this result object.
        /// </summary>
