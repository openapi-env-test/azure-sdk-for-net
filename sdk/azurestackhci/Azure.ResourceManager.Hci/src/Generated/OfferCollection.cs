...
namespace Azure.ResourceManager.Hci
{
    ...
    public partial class OfferCollection : ArmCollection, IEnumerable<OfferResource>, IAsyncEnumerable<OfferResource>
    {
        ...
        public virtual AsyncPageable<OfferResource> GetAllAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _offerClientDiagnostics.CreateScope("OfferCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _offerRestClient.ListByPublisherAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<OfferResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _offerRestClient.ListByPublisherNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new OfferResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<OfferResource> GetAll(string expand = null, CancellationToken cancellationToken = default)
        {
            Page<OfferResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _offerRestClient.ListByPublisher(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, expand, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new OfferResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<OfferResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _offerRestClient.ListByPublisherNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, expand, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new OfferResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
