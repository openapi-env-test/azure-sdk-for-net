...
namespace Azure.ResourceManager.Hci
{
    public partial class UpdateRunData : IUtf8JsonSerializable
    {
        ...
        internal static UpdateRunData DeserializeUpdateRunData(JsonElement element)
        {
            ...
            return new UpdateRunData(id, name, type, systemData.Value, Optional.ToNullable(location), Optional.ToNullable(provisioningState), duration.Value, Optional.ToNullable(state), name0.Value, description.Value, errorMessage.Value, status.Value, Optional.ToNullable(startTimeUtc), Optional.ToNullable(endTimeUtc), Optional.ToNullable(lastUpdatedTimeUtc), Optional.ToList(steps));
        }
    }
}
