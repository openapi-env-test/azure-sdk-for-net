...
namespace Microsoft.Azure.Management.NetApp.Models
{
    ...
    public partial class MonthlySchedule
    {
        ...
        public MonthlySchedule(int? snapshotsToKeep = default(int?), string daysOfMonth = default(string), int? hour = default(int?), int? minute = default(int?), int? usedBytes = default(int?))
        {
