...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    public partial class CostManagementClient : ServiceClient<CostManagementClient>, ICostManagementClient, IAzureClient
    {
        ...
        private void Initialize()
        {
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<BenefitRecommendationProperties>("scope"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<BenefitRecommendationProperties>("scope"));
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<BenefitUtilizationSummary>("kind"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<BenefitUtilizationSummary>("kind"));
            CustomInitialize();
