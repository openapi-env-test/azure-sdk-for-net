...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    /// </summary>
    internal partial class BenefitRecommendationsOperations : IServiceOperations<CostManagementClient>, IBenefitRecommendationsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<BenefitRecommendationModel>>> ListWithHttpMessagesAsync(string billingScope, string filter = default(string), string orderby = default(string), string expand = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<BenefitRecommendationModel>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<BenefitRecommendationModel>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<BenefitRecommendationModel>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
