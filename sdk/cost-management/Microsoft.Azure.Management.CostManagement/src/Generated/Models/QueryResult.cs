...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class QueryResult : CostManagementResource
    {
        /// <summary>
        ...
        public QueryResult(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string sku = default(string), string eTag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string nextLink = default(string), IList<QueryColumn> columns = default(IList<QueryColumn>), IList<IList<object>> rows = default(IList<IList<object>>))
