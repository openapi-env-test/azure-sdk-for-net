...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    /// </summary>
    public partial class ScheduledActionProxyResource : IResource
    {
        /// <summary>
        /// Initializes a new instance of the ScheduledActionProxyResource
        /// class.
        /// </summary>
        ...
        public ScheduledActionProxyResource(string eTag = default(string), string kind = default(string), SystemData systemData = default(SystemData))
        {
            ETag = eTag;
            Kind = kind;
        ...
        /// <summary>
        /// Gets resource Etag. For update calls, eTag is mandatory. Fetch the
        /// resource's eTag by doing a 'GET' call first and then including the
        /// latest eTag as part of the request body or 'If-Match' header while
        ...
        /// <summary>
        /// Gets or sets kind of the scheduled action. Possible values include:
        /// 'Email', 'InsightAlert'
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets kind of the scheduled action.
        /// </summary>
