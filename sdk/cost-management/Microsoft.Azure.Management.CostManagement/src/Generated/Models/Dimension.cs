...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class Dimension : CostManagementResource
    {
        /// <summary>
        ...
        /// results.</param>
        public Dimension(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string sku = default(string), string eTag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string description = default(string), bool? filterEnabled = default(bool?), bool? groupingEnabled = default(bool?), IList<string> data = default(IList<string>), int? total = default(int?), string category = default(string), System.DateTime? usageStart = default(System.DateTime?), System.DateTime? usageEnd = default(System.DateTime?), string nextLink = default(string))
            : base(id, name, type, location, sku, eTag, tags)
        {
