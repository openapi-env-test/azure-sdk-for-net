...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    /// </summary>
    public partial class CostManagementProxyResource : IResource
    {
        /// <summary>
        /// Initializes a new instance of the CostManagementProxyResource
        /// class.
        /// </summary>
        ...
        public CostManagementProxyResource(string id = default(string), string name = default(string), string type = default(string), string eTag = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
