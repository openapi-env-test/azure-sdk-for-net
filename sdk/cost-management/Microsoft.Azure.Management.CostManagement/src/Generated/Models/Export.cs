...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class Export : CostManagementProxyResource
    {
        /// <summary>
        ...
        /// 'Csv'</param>
        /// <param name="runHistory">If requested, has the most recent run
        /// history for the export.</param>
        ...
        /// Microsoft Customer Agreement commerce scopes.</param>
        /// <param name="nextRunTimeEstimate">If the export has an active
        /// schedule, provides an estimate of the next run time.</param>
        ...
        /// <summary>
        /// Gets or sets if requested, has the most recent run history for the
        /// export.
        /// </summary>
        ...
        /// Note: this option is currently available only for Microsoft
