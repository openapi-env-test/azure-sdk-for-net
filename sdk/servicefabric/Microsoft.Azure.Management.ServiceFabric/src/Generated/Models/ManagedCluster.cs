...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ManagedCluster : Resource
    {
        ...
        /// <param name="vmAdminUser">vm admin user name.</param>
        ...
        /// thumbprint used for admin client.</param>
        /// <param name="clusterCertificateCommonName">The cluster certificate
        /// common name used for admin client.</param>
        ...
        /// connections to the cluster.</param>
        /// <param name="loadBalancePorts">Load balance ports.</param>
        /// <param name="natPorts">Nat ports.</param>
        /// <param name="vmPassword">vm admin user password.</param>
        ...
        /// proxy.</param>
        public ManagedCluster(string location, string dnsName, string vmAdminUser, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), string fqdn = default(string), string clusterId = default(string), string clusterState = default(string), string clusterCertificateThumbprint = default(string), string clusterCertificateCommonName = default(string), int? clientConnectionPort = default(int?), int? httpGatewayConnectionPort = default(int?), IList<LoadBalancePort> loadBalancePorts = default(IList<LoadBalancePort>), IList<NatPort> natPorts = default(IList<NatPort>), string vmPassword = default(string), SettingsSectionDescription fabricSettings = default(SettingsSectionDescription), string provisioningState = default(string), string clusterCodeVersion = default(string), string clusterUpgradeMode = default(string), ClusterUpgradePolicy clusterUpgradeDescription = default(ClusterUpgradePolicy), int? reverseProxyEndpointPort = default(int?))
            : base(location, id, name, type, tags, etag)
        {
            ...
            LoadBalancePorts = loadBalancePorts;
            NatPorts = natPorts;
        ...
        /// <summary>
        /// Static constructor for ManagedCluster class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the cluster certificate thumbprint used for admin client.
        /// </summary>
        ...
        /// <summary>
        /// Gets the cluster certificate common name used for admin client.
        /// </summary>
        [JsonProperty(PropertyName = "properties.clusterCertificateCommonName")]
        public string ClusterCertificateCommonName { get; private set; }
        ...
        /// <summary>
        /// Gets or sets load balance ports.
        /// </summary>
        [JsonProperty(PropertyName = "properties.loadBalancePorts")]
        public IList<LoadBalancePort> LoadBalancePorts { get; set; }

        /// <summary>
        /// Gets or sets nat ports.
        /// </summary>
        [JsonProperty(PropertyName = "properties.natPorts")]
        public IList<NatPort> NatPorts { get; set; }

        /// <summary>
        /// Gets or sets vm admin user name.
        /// </summary>
        [JsonProperty(PropertyName = "properties.vmAdminUser")]
        public string VmAdminUser { get; set; }

        /// <summary>
        /// Gets or sets vm admin user password.
        /// </summary>
        [JsonProperty(PropertyName = "properties.vmPassword")]
        ...
        public override void Validate()
        {
            ...
            if (VmAdminUser == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "VmAdminUser");
            }
