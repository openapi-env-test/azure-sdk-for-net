...
namespace Microsoft.Azure.Management.ServiceFabric
{
    ...
    public partial interface IManagedClustersOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ManagedCluster>> CreateWithHttpMessagesAsync(string resourceGroupName, string clusterName, ManagedCluster parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<ManagedCluster>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string clusterName, ManagedCluster parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Updates the configuration of a Service Fabric managed cluster
        /// resource.
        /// </summary>
