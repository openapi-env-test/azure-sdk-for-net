      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_AppPlatformManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("AppPlatform", "RuntimeVersions", "2019-05-01-preview"),
                new Tuple<string, string, string>("AppPlatform", "Services", "2019-05-01-preview"),
                new Tuple<string, string, string>("AppPlatformManagementClient", "Health", "2019-05-01-preview"),
                new Tuple<string, string, string>("AppPlatformManagementClient", "Sku", "2019-05-01-preview"),
              }.AsEnumerable();
          }
      }
  }
