...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    public partial class ConfigurationNameItem
    {
        internal static ConfigurationNameItem DeserializeConfigurationNameItem(JsonElement element)
        {
            ...
            Optional<SecretSourceType?> secretType = default;
            ...
            return new ConfigurationNameItem(targetService.Value, Optional.ToNullable(clientType), Optional.ToNullable(authType), Optional.ToNullable(secretType), daprProperties.Value, Optional.ToList(names));
        }
    }
}
