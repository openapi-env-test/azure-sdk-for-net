...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    public partial class DaprProperties : IUtf8JsonSerializable
    {
        ...
        internal static DaprProperties DeserializeDaprProperties(JsonElement element)
        {
            ...
            Optional<DaprBindingComponentDirection?> bindingComponentDirection = default;
            ...
            return new DaprProperties(version.Value, componentType.Value, secretStoreComponent.Value, Optional.ToList(metadata), Optional.ToList(scopes), runtimeVersion.Value, Optional.ToNullable(bindingComponentDirection));
        }
    }
}
