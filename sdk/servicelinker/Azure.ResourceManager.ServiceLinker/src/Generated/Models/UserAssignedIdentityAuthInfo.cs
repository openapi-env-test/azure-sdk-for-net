...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class UserAssignedIdentityAuthInfo : AuthBaseInfo
    {
        ...
        internal UserAssignedIdentityAuthInfo(LinkerAuthType authType, AuthMode? authMode, string clientId, string subscriptionId, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType, authMode)
        {
            ClientId = clientId;
