...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    public partial class UserAccountAuthInfo : IUtf8JsonSerializable
    {
        ...
        internal static UserAccountAuthInfo DeserializeUserAccountAuthInfo(JsonElement element)
        {
            ...
            return new UserAccountAuthInfo(authType, Optional.ToNullable(principalId), Optional.ToNullable(deleteOrUpdateBehavior), Optional.ToList(roles), userName.Value);
        }
    }
}
