...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class UserAccountAuthInfo : AuthBaseInfo
    {
        ...
        internal UserAccountAuthInfo(LinkerAuthType authType, AuthMode? authMode, IDictionary<string, BinaryData> serializedAdditionalRawData, Guid? principalId, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType, authMode, serializedAdditionalRawData)
        {
