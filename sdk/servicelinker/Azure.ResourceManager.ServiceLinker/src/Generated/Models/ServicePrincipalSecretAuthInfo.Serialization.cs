...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    public partial class ServicePrincipalSecretAuthInfo : IUtf8JsonSerializable
    {
        ...
        internal static ServicePrincipalSecretAuthInfo DeserializeServicePrincipalSecretAuthInfo(JsonElement element)
        {
            ...
            return new ServicePrincipalSecretAuthInfo(authType, Optional.ToNullable(authMode), clientId, principalId, secret, Optional.ToNullable(deleteOrUpdateBehavior), Optional.ToList(roles), userName.Value);
        }
    }
}
