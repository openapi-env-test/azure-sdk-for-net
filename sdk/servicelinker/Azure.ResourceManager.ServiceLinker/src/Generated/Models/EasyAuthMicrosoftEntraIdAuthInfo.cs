...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class EasyAuthMicrosoftEntraIdAuthInfo : AuthBaseInfo
    {
        ...
        internal EasyAuthMicrosoftEntraIdAuthInfo(LinkerAuthType authType, AuthMode? authMode, string clientId, string secret, DeleteOrUpdateBehavior? deleteOrUpdateBehavior) : base(authType, authMode)
        {
            ClientId = clientId;
            Secret = secret;
