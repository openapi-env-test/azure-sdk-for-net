...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public partial class ServicePrincipalSecretAuthInfo : AuthBaseInfo
    {
        ...
        internal ServicePrincipalSecretAuthInfo(LinkerAuthType authType, AuthMode? authMode, string clientId, Guid principalId, string secret, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType, authMode)
        {
            ClientId = clientId;
            PrincipalId = principalId;
            Secret = secret;
