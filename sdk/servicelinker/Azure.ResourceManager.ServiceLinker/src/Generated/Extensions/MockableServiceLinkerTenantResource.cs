...
namespace Azure.ResourceManager.ServiceLinker.Mocking
{
    ...
    public partial class MockableServiceLinkerTenantResource : ArmResource
    {
        ...
        public virtual AsyncPageable<ConfigurationNameItem> GetConfigurationNamesAsync(string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ConfigurationNameItem.DeserializeConfigurationNameItem, ConfigurationNamesClientDiagnostics, Pipeline, "MockableServiceLinkerTenantResource.GetConfigurationNames", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ConfigurationNameItem> GetConfigurationNames(string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ConfigurationNamesRestClient.CreateListRequest(filter, skipToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ConfigurationNamesRestClient.CreateListNextPageRequest(nextLink, filter, skipToken);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ConfigurationNameItem.DeserializeConfigurationNameItem, ConfigurationNamesClientDiagnostics, Pipeline, "MockableServiceLinkerTenantResource.GetConfigurationNames", "value", "nextLink", cancellationToken);
        }
    }
}
