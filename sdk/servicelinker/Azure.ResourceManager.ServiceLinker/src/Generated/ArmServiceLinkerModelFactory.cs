...
namespace Azure.ResourceManager.ServiceLinker.Models
{
    ...
    public static partial class ArmServiceLinkerModelFactory
    {
        ...
        /// The available derived classes include <see cref="Models.CreateOrUpdateDryrunParameters"/>.
        /// </param>
        ...
        public static DaprProperties DaprProperties(string version = null, string componentType = null, string secretStoreComponent = null, IEnumerable<DaprMetadata> metadata = null, IEnumerable<string> scopes = null, string runtimeVersion = null, DaprBindingComponentDirection? bindingComponentDirection = null)
        {
            ...
            return new DaprProperties(version, componentType, secretStoreComponent, metadata?.ToList(), scopes?.ToList(), runtimeVersion, bindingComponentDirection);
        }
        ...
        {
            return new SourceConfiguration(name, value, configType, keyVaultReferenceIdentity, description);
        }
        ...
        public static ConfigurationNameItem ConfigurationNameItem(string targetService = null, LinkerClientType? clientType = null, LinkerAuthType? authType = null, SecretSourceType? secretType = null, DaprProperties daprProperties = null, IEnumerable<ConfigurationName> names = null)
        {
            ...
            return new ConfigurationNameItem(targetService, clientType, authType, secretType, daprProperties, names?.ToList());
        }
        ...
        {
            return new DaprConfigurationResource(targetType, authType, daprProperties);
        }

        /// <summary> Initializes a new instance of <see cref="Models.CreateOrUpdateDryrunParameters"/>. </summary>
        /// <param name="targetService">
        /// The target service properties
        /// Please note <see cref="TargetServiceBaseInfo"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="AzureResourceInfo"/>, <see cref="ConfluentBootstrapServerInfo"/>, <see cref="ConfluentSchemaRegistryInfo"/> and <see cref="SelfHostedServer"/>.
