...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class ManagedClusterPodIdentity
    {
        ...
        public ManagedClusterPodIdentity(string name, string namespaceProperty, UserAssignedIdentity identity, string provisioningState = default(string), ManagedClusterPodIdentityProvisioningInfo provisioningInfo = default(ManagedClusterPodIdentityProvisioningInfo))
        {
            Name = name;
