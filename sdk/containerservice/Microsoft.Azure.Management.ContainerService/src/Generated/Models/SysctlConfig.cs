...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class SysctlConfig
    {
        ...
        /// <param name="netIpv4TcpRmem">Sysctl setting
        /// net.ipv4.tcp_rmem.</param>
        /// <param name="netIpv4TcpWmem">Sysctl setting
        /// net.ipv4.tcp_wmem.</param>
        ...
        /// <summary>
        /// Gets or sets sysctl setting net.ipv4.tcp_rmem.
        /// </summary>
        [JsonProperty(PropertyName = "netIpv4TcpRmem")]
        public int? NetIpv4TcpRmem { get; set; }

        /// <summary>
        /// Gets or sets sysctl setting net.ipv4.tcp_wmem.
        /// </summary>
        [JsonProperty(PropertyName = "netIpv4TcpWmem")]
        public int? NetIpv4TcpWmem { get; set; }
