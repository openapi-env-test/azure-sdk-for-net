...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class AgentPoolsUpgradeNodeImageVersionOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal AgentPoolsUpgradeNodeImageVersionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AgentPoolsUpgradeNodeImageVersionOperation");
        }
        /// <inheritdoc />
