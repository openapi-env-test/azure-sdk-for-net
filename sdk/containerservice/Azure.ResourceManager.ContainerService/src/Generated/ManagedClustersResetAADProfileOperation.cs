...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ManagedClustersResetAADProfileOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal ManagedClustersResetAADProfileOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedClustersResetAADProfileOperation");
        }
        /// <inheritdoc />
