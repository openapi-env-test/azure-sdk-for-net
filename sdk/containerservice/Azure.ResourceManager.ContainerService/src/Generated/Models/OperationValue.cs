...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OperationValue. </summary>
        ...
        internal OperationValue(string origin, string name, string operation, string resource, string description, string provider)
        {
            Origin = origin;
            Name = name;
            Operation = operation;
