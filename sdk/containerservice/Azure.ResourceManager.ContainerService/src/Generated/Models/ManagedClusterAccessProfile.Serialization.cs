    ...
    public partial class ManagedClusterAccessProfile : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(KubeConfig))
            {
                ...
                writer.WriteBase64StringValue(KubeConfig);
            }
            writer.WriteEndObject();
            writer.WriteEndObject();
        }
        ...
        internal static ManagedClusterAccessProfile DeserializeManagedClusterAccessProfile(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("kubeConfig"))
                        {
                            ...
                            kubeConfig = property0.Value.GetBytesFromBase64();
                            continue;
                        }
                    }
                    continue;
            ...
            return new ManagedClusterAccessProfile(id.Value, name.Value, type.Value, location, Optional.ToDictionary(tags), kubeConfig.Value);
        }
    }
}
