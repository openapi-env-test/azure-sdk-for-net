...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterAgentPoolProfileProperties
    {
        ...
        internal ManagedClusterAgentPoolProfileProperties(int? count, ContainerServiceVMSizeTypes? vmSize, int? osDiskSizeGB, OSDiskType? osDiskType, KubeletDiskType? kubeletDiskType, string vnetSubnetID, string podSubnetID, int? maxPods, OSType? osType, int? maxCount, int? minCount, bool? enableAutoScaling, AgentPoolType? type, AgentPoolMode? mode, string orchestratorVersion, string nodeImageVersion, AgentPoolUpgradeSettings upgradeSettings, string provisioningState, PowerState powerState, IList<string> availabilityZones, bool? enableNodePublicIP, ScaleSetPriority? scaleSetPriority, ScaleSetEvictionPolicy? scaleSetEvictionPolicy, float? spotMaxPrice, IDictionary<string, string> tags, IDictionary<string, string> nodeLabels, IList<string> nodeTaints, string proximityPlacementGroupID, KubeletConfig kubeletConfig, LinuxOSConfig linuxOSConfig, bool? enableEncryptionAtHost)
        {
            Count = count;
            VmSize = vmSize;
