...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class ManagedClusterListResult
    {
        ...
        {
            Optional<IReadOnlyList<ManagedCluster>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    ...
                    List<ManagedCluster> array = new List<ManagedCluster>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ManagedCluster.DeserializeManagedCluster(item));
                    }
                    value = array;
                    continue;
                }
