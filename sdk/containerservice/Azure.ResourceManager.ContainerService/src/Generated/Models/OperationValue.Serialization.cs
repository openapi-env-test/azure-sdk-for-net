...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        internal static OperationValue DeserializeOperationValue(JsonElement element)
        {
            ...
            return new OperationValue(origin.Value, name.Value, operation.Value, resource.Value, description.Value, provider.Value);
        }
    }
}
