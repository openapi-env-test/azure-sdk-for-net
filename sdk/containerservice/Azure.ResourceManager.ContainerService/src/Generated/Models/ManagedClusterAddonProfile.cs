...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterAddonProfile
    {
        ...
        internal ManagedClusterAddonProfile(bool enabled, IDictionary<string, string> config, UserAssignedIdentity identity)
        {
            Enabled = enabled;
            Config = config;
            Identity = identity;
        ...
        public UserAssignedIdentity Identity { get; }
    }
}
