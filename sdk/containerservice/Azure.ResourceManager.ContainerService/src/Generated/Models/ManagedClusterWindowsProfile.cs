...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterWindowsProfile
    {
        ...
        /// <param name="licenseType"> The licenseType to use for Windows VMs. Windows_Server is used to enable Azure Hybrid User Benefits for Windows VMs. </param>
        internal ManagedClusterWindowsProfile(string adminUsername, string adminPassword, LicenseType? licenseType)
        {
            AdminUsername = adminUsername;
        ...
        /// <summary> The licenseType to use for Windows VMs. Windows_Server is used to enable Azure Hybrid User Benefits for Windows VMs. </summary>
