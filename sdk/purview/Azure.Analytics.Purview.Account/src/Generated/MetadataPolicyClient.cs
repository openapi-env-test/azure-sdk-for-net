...
namespace Azure.Analytics.Purview.Account
{
    ...
    public partial class MetadataPolicyClient
    {
        ...
        public MetadataPolicyClient(string endpoint, string collectionName, TokenCredential credential) : this(endpoint, collectionName, credential, new PurviewAccountClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/>, <paramref name="collectionName"/> or <paramref name="credential"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="collectionName"/> is an empty string, and was expected to be non-empty. </exception>
        public MetadataPolicyClient(string endpoint, string collectionName, TokenCredential credential, PurviewAccountClientOptions options)
        {
        ...
        /// <include file="Docs/MetadataPolicyClient.xml" path="doc/members/member[@name='UpdateAsync(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/MetadataPolicyClient.xml" path="doc/members/member[@name='Update(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/MetadataPolicyClient.xml" path="doc/members/member[@name='GetMetadataPolicyAsync(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/MetadataPolicyClient.xml" path="doc/members/member[@name='GetMetadataPolicy(String,RequestContext)']/*" />
        ...
        /// <include file="Docs/MetadataPolicyClient.xml" path="doc/members/member[@name='GetMetadataPoliciesAsync(RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetMetadataPoliciesAsync(RequestContext context = null)
        {
            return GetMetadataPoliciesImplementationAsync("MetadataPolicyClient.GetMetadataPolicies", context);
        }
        ...
        /// <include file="Docs/MetadataPolicyClient.xml" path="doc/members/member[@name='GetMetadataPolicies(RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetMetadataPolicies(RequestContext context = null)
        {
            return GetMetadataPoliciesImplementation("MetadataPolicyClient.GetMetadataPolicies", context);
        }
