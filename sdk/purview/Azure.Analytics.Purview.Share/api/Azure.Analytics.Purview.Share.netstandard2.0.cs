namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class GlossaryClient
    {
        ...
        public virtual Azure.Operation<System.BinaryData> DeleteGlossaryTermsByGuids(Azure.WaitUntil waitUntil, Azure.Core.RequestContent content, bool? forceDeleteEntityAssignment = default(bool?), bool? forceDeleteChild = default(bool?), Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation<System.BinaryData>> DeleteGlossaryTermsByGuidsAsync(Azure.WaitUntil waitUntil, Azure.Core.RequestContent content, bool? forceDeleteEntityAssignment = default(bool?), bool? forceDeleteChild = default(bool?), Azure.RequestContext context = null) { throw null; }
        ...
        public virtual Azure.Response GetBulkDeleteOperationStatus(string operationGuid, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> GetBulkDeleteOperationStatusAsync(string operationGuid, Azure.RequestContext context = null) { throw null; }
    ...
    public partial class LineageClient
    {
        ...
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
        public virtual Azure.Response GetLineageByUniqueAttribute(string typeName, string direction, int? depth = default(int?), int? width = default(int?), bool? includeParent = default(bool?), bool? getDerivedLineage = default(bool?), string attrQualifiedName = null, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> GetLineageByUniqueAttributeAsync(string typeName, string direction, int? depth = default(int?), int? width = default(int?), bool? includeParent = default(bool?), bool? getDerivedLineage = default(bool?), string attrQualifiedName = null, Azure.RequestContext context = null) { throw null; }
    ...
    {
        public PurviewShareClientOptions(Azure.Analytics.Purview.Share.PurviewShareClientOptions.ServiceVersion version = Azure.Analytics.Purview.Share.PurviewShareClientOptions.ServiceVersion.V2022_08_01_Preview) { }
        public enum ServiceVersion
        {
            V2018_12_01_Preview = 1,
            V2021_07_01_Preview = 2,
            V2021_09_01_Preview = 3,
            V2022_08_01_Preview = 4,
        }
    }
