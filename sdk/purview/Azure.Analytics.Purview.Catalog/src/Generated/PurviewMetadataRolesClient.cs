...
namespace Azure.Analytics.Purview.Catalog
{
    ...
    public partial class PurviewMetadataRolesClient
    {
        ...
        public PurviewMetadataRolesClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewCatalogClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewMetadataRolesClient(Uri endpoint, TokenCredential credential, PurviewCatalogClientOptions options)
        {
        ...
        /// 
        /// </remarks>
        public virtual AsyncPageable<BinaryData> GetPurviewMetadataRoleAsync(RequestContext context = null)
        {
            return GetPurviewMetadataRoleImplementationAsync("PurviewMetadataRolesClient.GetPurviewMetadataRole", context);
        }

        private AsyncPageable<BinaryData> GetPurviewMetadataRoleImplementationAsync(string diagnosticsScopeName, RequestContext context)
        {
            ...
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
                        ? CreateGetPurviewMetadataRoleRequest(context)
                        : CreateGetPurviewMetadataRoleNextPageRequest(nextLink, context);
        ...
        /// 
        /// </remarks>
        public virtual Pageable<BinaryData> GetPurviewMetadataRole(RequestContext context = null)
        {
            return GetPurviewMetadataRoleImplementation("PurviewMetadataRolesClient.GetPurviewMetadataRole", context);
        }

        private Pageable<BinaryData> GetPurviewMetadataRoleImplementation(string diagnosticsScopeName, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetPurviewMetadataRoleRequest(RequestContext context)
        {
        ...
        internal HttpMessage CreateGetPurviewMetadataRoleNextPageRequest(string nextLink, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
