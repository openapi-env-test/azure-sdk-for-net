...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class SentShareInvitationsClient
    {
        ...
        public SentShareInvitationsClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewScanningServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public SentShareInvitationsClient(string endpoint, TokenCredential credential, PurviewScanningServiceClientOptions options)
        {
