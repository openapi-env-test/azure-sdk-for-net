...
{
    // Data plane generated client. The Glossary service client.
    /// <summary> The Glossary service client. </summary>
    public partial class GlossaryClient
    {
        ...
        /// <summary> Initializes a new instance of GlossaryClient for mocking. </summary>
        protected GlossaryClient()
        {
        }

        /// <summary> Initializes a new instance of GlossaryClient. </summary>
        /// <param name="endpoint"> The catalog endpoint of your Purview account. Example: https://{accountName}.purview.azure.com. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public GlossaryClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewScanningServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public GlossaryClient(Uri endpoint, TokenCredential credential, PurviewScanningServiceClientOptions options)
        {
        ...
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossariesAsync(Int32,Int32,String,Boolean,RequestContext)']/*" />
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossaries");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaries(Int32,Int32,String,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateGlossaryAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.CreateGlossary");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossary(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryCategoriesAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateGlossaryCategoriesAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.CreateGlossaryCategories");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryCategories(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryCategoryAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateGlossaryCategoryAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.CreateGlossaryCategory");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryCategory(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryCategoryAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetGlossaryCategoryAsync(string categoryGuid, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossaryCategory");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryCategory(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='UpdateGlossaryCategoryAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateGlossaryCategoryAsync(string categoryGuid, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.UpdateGlossaryCategory");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='UpdateGlossaryCategory(String,RequestContent,RequestContext)']/*" />
        ...
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossaryCategoryAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> DeleteGlossaryCategoryAsync(string categoryGuid, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(categoryGuid, nameof(categoryGuid));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.DeleteGlossaryCategory");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossaryCategory(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='PartialUpdateGlossaryCategoryAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PartialUpdateGlossaryCategoryAsync(string categoryGuid, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.PartialUpdateGlossaryCategory");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='PartialUpdateGlossaryCategory(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetRelatedCategoriesAsync(String,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetRelatedCategoriesAsync(string categoryGuid, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetRelatedCategories");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetRelatedCategories(String,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetCategoryTermsAsync(String,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetCategoryTermsAsync(string categoryGuid, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetCategoryTerms");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetCategoryTerms(String,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryTermAsync(RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> CreateGlossaryTermAsync(RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.CreateGlossaryTerm");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryTerm(RequestContent,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryTermAsync(String,Boolean,IEnumerable,RequestContext)']/*" />
        public virtual async Task<Response> GetGlossaryTermAsync(string termGuid, bool? includeTermHierarchy = null, IEnumerable<string> excludeRelationshipTypeList = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossaryTerm");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryTerm(String,Boolean,IEnumerable,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='UpdateGlossaryTermAsync(String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> UpdateGlossaryTermAsync(string termGuid, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.UpdateGlossaryTerm");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='UpdateGlossaryTerm(String,RequestContent,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossaryTermAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> DeleteGlossaryTermAsync(string termGuid, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(termGuid, nameof(termGuid));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.DeleteGlossaryTerm");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossaryTerm(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='PartialUpdateGlossaryTermAsync(String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> PartialUpdateGlossaryTermAsync(string termGuid, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.PartialUpdateGlossaryTerm");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='PartialUpdateGlossaryTerm(String,RequestContent,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryTermsAsync(RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> CreateGlossaryTermsAsync(RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.CreateGlossaryTerms");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='CreateGlossaryTerms(RequestContent,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetEntitiesAssignedWithTermAsync(String,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetEntitiesAssignedWithTermAsync(string termGuid, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetEntitiesAssignedWithTerm");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetEntitiesAssignedWithTerm(String,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='AssignTermToEntitiesAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> AssignTermToEntitiesAsync(string termGuid, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.AssignTermToEntities");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='AssignTermToEntities(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='RemoveTermAssignmentFromEntitiesAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> RemoveTermAssignmentFromEntitiesAsync(string termGuid, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.RemoveTermAssignmentFromEntities");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='RemoveTermAssignmentFromEntities(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteTermAssignmentFromEntitiesAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> DeleteTermAssignmentFromEntitiesAsync(string termGuid, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.DeleteTermAssignmentFromEntities");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteTermAssignmentFromEntities(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetRelatedTermsAsync(String,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetRelatedTermsAsync(string termGuid, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetRelatedTerms");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetRelatedTerms(String,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetGlossaryAsync(string glossaryGuid, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossary");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossary(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='UpdateGlossaryAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateGlossaryAsync(string glossaryGuid, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.UpdateGlossary");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='UpdateGlossary(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossaryAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> DeleteGlossaryAsync(string glossaryGuid, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(glossaryGuid, nameof(glossaryGuid));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.DeleteGlossary");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossary(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryCategoriesAsync(String,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetGlossaryCategoriesAsync(string glossaryGuid, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossaryCategories");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryCategories(String,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryCategoriesHeadersAsync(String,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetGlossaryCategoriesHeadersAsync(string glossaryGuid, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossaryCategoriesHeaders");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryCategoriesHeaders(String,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetDetailedGlossaryAsync(String,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> GetDetailedGlossaryAsync(string glossaryGuid, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetDetailedGlossary");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetDetailedGlossary(String,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='PartialUpdateGlossaryAsync(String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> PartialUpdateGlossaryAsync(string glossaryGuid, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.PartialUpdateGlossary");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='PartialUpdateGlossary(String,RequestContent,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryTermsAsync(String,Boolean,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetGlossaryTermsAsync(string glossaryGuid, bool? includeTermHierarchy = null, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossaryTerms");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryTerms(String,Boolean,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryTermHeadersAsync(String,Int32,Int32,String,RequestContext)']/*" />
        public virtual async Task<Response> GetGlossaryTermHeadersAsync(string glossaryGuid, int? limit = null, int? offset = null, string sort = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetGlossaryTermHeaders");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetGlossaryTermHeaders(String,Int32,Int32,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetImportCsvOperationStatusAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetImportCsvOperationStatusAsync(string operationGuid, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetImportCsvOperationStatus");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetImportCsvOperationStatus(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='ExportGlossaryTermsAsCsvAsync(String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> ExportGlossaryTermsAsCsvAsync(string glossaryGuid, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.ExportGlossaryTermsAsCsv");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='ExportGlossaryTermsAsCsv(String,RequestContent,Boolean,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetTermsByGlossaryNameAsync(String,Int32,Int32,Boolean,RequestContext)']/*" />
        public virtual async Task<Response> GetTermsByGlossaryNameAsync(string glossaryName, int? limit = null, int? offset = null, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetTermsByGlossaryName");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetTermsByGlossaryName(String,Int32,Int32,Boolean,RequestContext)']/*" />
        ...
        /// <summary> Get the status of bulk delete operation. </summary>
        /// <param name="operationGuid"> The globally unique identifier for async operation/job. </param>
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="operationGuid"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="operationGuid"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetBulkDeleteOperationStatusAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetBulkDeleteOperationStatusAsync(string operationGuid, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(operationGuid, nameof(operationGuid));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.GetBulkDeleteOperationStatus");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetBulkDeleteOperationStatusRequest(operationGuid, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='GetBulkDeleteOperationStatus(String,RequestContext)']/*" />
        public virtual Response GetBulkDeleteOperationStatus(string operationGuid, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(operationGuid, nameof(operationGuid));
        ...
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='ImportGlossaryTermsViaCsvAsync(WaitUntil,String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> ImportGlossaryTermsViaCsvAsync(WaitUntil waitUntil, string glossaryGuid, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.ImportGlossaryTermsViaCsv");
            scope.Start();
            try
            {
                using HttpMessage message = CreateImportGlossaryTermsViaCsvRequest(glossaryGuid, content, includeTermHierarchy, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "GlossaryClient.ImportGlossaryTermsViaCsv", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='ImportGlossaryTermsViaCsv(WaitUntil,String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual Operation<BinaryData> ImportGlossaryTermsViaCsv(WaitUntil waitUntil, string glossaryGuid, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateImportGlossaryTermsViaCsvRequest(glossaryGuid, content, includeTermHierarchy, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "GlossaryClient.ImportGlossaryTermsViaCsv", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='ImportGlossaryTermsViaCsvByGlossaryNameAsync(WaitUntil,String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> ImportGlossaryTermsViaCsvByGlossaryNameAsync(WaitUntil waitUntil, string glossaryName, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.ImportGlossaryTermsViaCsvByGlossaryName");
            scope.Start();
            try
            {
                ...
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "GlossaryClient.ImportGlossaryTermsViaCsvByGlossaryName", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='ImportGlossaryTermsViaCsvByGlossaryName(WaitUntil,String,RequestContent,Boolean,RequestContext)']/*" />
        public virtual Operation<BinaryData> ImportGlossaryTermsViaCsvByGlossaryName(WaitUntil waitUntil, string glossaryName, RequestContent content, bool? includeTermHierarchy = null, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateImportGlossaryTermsViaCsvByGlossaryNameRequest(glossaryName, content, includeTermHierarchy, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "GlossaryClient.ImportGlossaryTermsViaCsvByGlossaryName", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Delete Glossary Terms. </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="content"> The content to send as the body of the request. Details of the request body schema are in the Remarks section below. </param>
        /// <param name="forceDeleteEntityAssignment"> Whether delete entity assignment. </param>
        /// <param name="forceDeleteChild"> Whether delete child terms together with the parent term. </param>
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossaryTermsByGuidsAsync(WaitUntil,RequestContent,Boolean,Boolean,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> DeleteGlossaryTermsByGuidsAsync(WaitUntil waitUntil, RequestContent content, bool? forceDeleteEntityAssignment = null, bool? forceDeleteChild = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("GlossaryClient.DeleteGlossaryTermsByGuids");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteGlossaryTermsByGuidsRequest(content, forceDeleteEntityAssignment, forceDeleteChild, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "GlossaryClient.DeleteGlossaryTermsByGuids", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/GlossaryClient.xml" path="doc/members/member[@name='DeleteGlossaryTermsByGuids(WaitUntil,RequestContent,Boolean,Boolean,RequestContext)']/*" />
        public virtual Operation<BinaryData> DeleteGlossaryTermsByGuids(WaitUntil waitUntil, RequestContent content, bool? forceDeleteEntityAssignment = null, bool? forceDeleteChild = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            {
                using HttpMessage message = CreateDeleteGlossaryTermsByGuidsRequest(content, forceDeleteEntityAssignment, forceDeleteChild, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "GlossaryClient.DeleteGlossaryTermsByGuids", OperationFinalStateVia.AzureAsyncOperation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateGetBulkDeleteOperationStatusRequest(string operationGuid, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            uri.Reset(_endpoint);
            uri.AppendRaw("/catalog/api", false);
            uri.AppendPath("/glossary/terms/bulkDeletion/", false);
            uri.AppendPath(operationGuid, true);
            uri.AppendQuery("api-version", "2022-08-01-preview", true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
        ...
        internal HttpMessage CreateDeleteGlossaryTermsByGuidsRequest(RequestContent content, bool? forceDeleteEntityAssignment, bool? forceDeleteChild, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier202);
            var request = message.Request;
            request.Method = RequestMethod.Delete;
            ...
            uri.Reset(_endpoint);
            uri.AppendRaw("/catalog/api", false);
            uri.AppendPath("/glossary/terms", false);
            if (forceDeleteEntityAssignment != null)
            {
                uri.AppendQuery("forceDeleteEntityAssignment", forceDeleteEntityAssignment.Value, true);
            }
            if (forceDeleteChild != null)
            {
                uri.AppendQuery("forceDeleteChild", forceDeleteChild.Value, true);
            }
            uri.AppendQuery("api-version", "2022-08-01-preview", true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
