...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class AccountsClient
    {
        ...
        public AccountsClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewScanningServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AccountsClient(string endpoint, TokenCredential credential, PurviewScanningServiceClientOptions options)
        {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("AccountsClient.GetAccountProperties");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> UpdateAccountPropertiesAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AccountsClient.UpdateAccountProperties");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("AccountsClient.GetAccessKeys");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> RegenerateAccessKeyAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AccountsClient.RegenerateAccessKey");
            scope.Start();
            try
            {
