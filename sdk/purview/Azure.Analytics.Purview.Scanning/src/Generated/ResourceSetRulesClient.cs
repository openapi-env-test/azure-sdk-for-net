...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class ResourceSetRulesClient
    {
        ...
        public ResourceSetRulesClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewScanningServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ResourceSetRulesClient(string endpoint, TokenCredential credential, PurviewScanningServiceClientOptions options)
        {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ResourceSetRulesClient.GetResourceSetRule");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CreateOrUpdateResourceSetRuleAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ResourceSetRulesClient.CreateOrUpdateResourceSetRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ResourceSetRulesClient.DeleteResourceSetRule");
            scope.Start();
            try
            {
        ...
        {
            return GetResourceSetRulesImplementationAsync("ResourceSetRulesClient.GetResourceSetRules", skipToken, context);
        }
        ...
        {
            return GetResourceSetRulesImplementation("ResourceSetRulesClient.GetResourceSetRules", skipToken, context);
        }
