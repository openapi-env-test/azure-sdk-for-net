...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class ReceivedSharesClient
    {
        ...
        public ReceivedSharesClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewScanningServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ReceivedSharesClient(string endpoint, TokenCredential credential, PurviewScanningServiceClientOptions options)
        {
