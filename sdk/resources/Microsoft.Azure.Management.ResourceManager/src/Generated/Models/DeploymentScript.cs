...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class DeploymentScript : AzureResourceBase
    {
        ...
        public DeploymentScript(ManagedServiceIdentity identity, string location, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), IDictionary<string, string> tags = default(IDictionary<string, string>))
            : base(id, name, type)
        {
            Identity = identity;
            Location = location;
