...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class Identity
    {
        ...
        public Identity(string principalId = default(string), string tenantId = default(string), ResourceIdentityType? type = default(ResourceIdentityType?), IDictionary<string, Componentsschemasidentitypropertiesuserassignedidentitiesadditionalproperties> userAssignedIdentities = default(IDictionary<string, Componentsschemasidentitypropertiesuserassignedidentitiesadditionalproperties>))
        {
        ...
        public IDictionary<string, Componentsschemasidentitypropertiesuserassignedidentitiesadditionalproperties> UserAssignedIdentities { get; set; }
