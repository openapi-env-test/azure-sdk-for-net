...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ActiveConfiguration : SubResource
    {
        /// <summary>
        ...
        /// <param name="commits">configuration Id need to deploy.</param>
        ...
        public ActiveConfiguration(string id = default(string), IList<CommitItem> commits = default(IList<CommitItem>), System.DateTime? deploymentTime = default(System.DateTime?), string provisioningState = default(string), string name = default(string), string type = default(string), string etag = default(string))
            : base(id)
        {
            Commits = commits;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.commits")]
        public IList<CommitItem> Commits { get; set; }
