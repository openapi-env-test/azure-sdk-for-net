...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class BackendAddressPool : SubResource
    {
        ...
        public BackendAddressPool(string id = default(string), IList<SubResource> backendIPConfigurations = default(IList<SubResource>), IList<SubResource> loadBalancingRules = default(IList<SubResource>), SubResource outboundNatRule = default(SubResource), string provisioningState = default(string), string name = default(string), string etag = default(string))
            : base(id)
        {
