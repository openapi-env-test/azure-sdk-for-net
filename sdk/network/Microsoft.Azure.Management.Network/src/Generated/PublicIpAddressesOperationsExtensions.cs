...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class PublicIpAddressesOperationsExtensions
    {
            ...
            {
                return operations.GetAsync(resourceGroupName, publicIpAddressName).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(resourceGroupName, publicIpAddressName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
