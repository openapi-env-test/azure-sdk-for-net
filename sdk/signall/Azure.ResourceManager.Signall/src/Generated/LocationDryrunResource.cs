...
namespace Azure.ResourceManager.Signall
{
    ...
    public partial class LocationDryrunResource : ArmResource
    {
        ...
        {
            _locationDryrunConnectorClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Signall", ResourceType.Namespace, Diagnostics);
        ...
        /// delete a dryrun job
        /// Request Path: /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.ServiceLinker/locations/{location}/dryruns/{dryrunName}
        /// Operation Id: Connector_DeleteDryrun
        /// </summary>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SignallArmOperation(response);
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.ServiceLinker/locations/{location}/dryruns/{dryrunName}
        /// Operation Id: Connector_UpdateDryrun
        /// </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        ...
        public virtual async Task<ArmOperation<LocationDryrunResource>> UpdateAsync(WaitUntil waitUntil, DryrunPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SignallArmOperation<LocationDryrunResource>(new LocationDryrunOperationSource(Client), _locationDryrunConnectorClientDiagnostics, Pipeline, _locationDryrunConnectorRestClient.CreateUpdateDryrunRequest(Id.SubscriptionId, Id.ResourceGroupName, new AzureLocation(Id.Parent.Name), Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
