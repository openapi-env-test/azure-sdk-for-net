...
#pragma warning disable SA1649 // File name should match first type name
    internal class SignallArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal SignallArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal SignallArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "SignallArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
