...
namespace Azure.ResourceManager.Signall.Models
{
    ...
    internal partial class ConfigurationNameResult
    {
        ...
        {
            Value = new ChangeTrackingList<ConfigurationNames>();
        }

        /// <summary> Initializes a new instance of ConfigurationNameResult. </summary>
        /// <param name="value"> Expected configuration names for each target service. </param>
        /// <param name="nextLink"> Link to next page of resources. </param>
        internal ConfigurationNameResult(IReadOnlyList<ConfigurationNames> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ConfigurationNames> Value { get; }
