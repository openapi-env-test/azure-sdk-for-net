...
namespace Azure.ResourceManager.Signall.Models
{
    ...
    public partial class UserAssignedIdentityAuthInfo : AuthInfoBase
    {
        ...
        internal UserAssignedIdentityAuthInfo(AuthType authType, string clientId, string subscriptionId, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType)
        {
            ClientId = clientId;
