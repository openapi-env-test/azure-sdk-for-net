...
namespace Azure.ResourceManager.Signall.Models
{
    ...
    public partial class ConfigurationInfo
    {
        ...
        internal ConfigurationInfo(DeleteOrUpdateBehavior? deleteOrUpdateBehavior, ActionType? action, IDictionary<string, string> customizedKeys, IDictionary<string, string> additionalConfigurations)
        {
