...
namespace Azure.ResourceManager.Signall
{
    ...
    public partial class DryrunCollection : ArmCollection, IEnumerable<DryrunResource>, IAsyncEnumerable<DryrunResource>
    {
        ...
        {
            _dryrunLinkersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Signall", DryrunResource.ResourceType.Namespace, Diagnostics);
        ...
        /// Operation Id: Linkers_CreateDryrun
        /// </summary>
        ...
        public virtual async Task<ArmOperation<DryrunResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string dryrunName, DryrunResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SignallArmOperation<DryrunResource>(new DryrunOperationSource(Client), _dryrunLinkersClientDiagnostics, Pipeline, _dryrunLinkersRestClient.CreateCreateDryrunRequest(Id, dryrunName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <summary>
        /// list dryrun jobs
        /// Request Path: /{resourceUri}/providers/Microsoft.ServiceLinker/dryruns
        /// Operation Id: Linkers_ListDryrun
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            async Task<Page<DryrunResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _dryrunLinkersClientDiagnostics.CreateScope("DryrunCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _dryrunLinkersRestClient.ListDryrunAsync(Id, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DryrunResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<DryrunResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _dryrunLinkersClientDiagnostics.CreateScope("DryrunCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _dryrunLinkersRestClient.ListDryrunNextPageAsync(nextLink, Id, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DryrunResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<DryrunResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _dryrunLinkersClientDiagnostics.CreateScope("DryrunCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _dryrunLinkersRestClient.ListDryrun(Id, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DryrunResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DryrunResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _dryrunLinkersClientDiagnostics.CreateScope("DryrunCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _dryrunLinkersRestClient.ListDryrunNextPage(nextLink, Id, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DryrunResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
