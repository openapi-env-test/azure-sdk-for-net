...
{
    /// <summary> A class to add extension methods to Azure.ResourceManager.Releaseplannertest. </summary>
    public static partial class ReleaseplannertestExtensions
    {
        ...
        #region ReleaseplannertestPrivateEndpointConnectionResource
        /// <summary>
        /// Gets an object representing a <see cref="ReleaseplannertestPrivateEndpointConnectionResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="ReleaseplannertestPrivateEndpointConnectionResource.CreateResourceIdentifier" /> to create a <see cref="ReleaseplannertestPrivateEndpointConnectionResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="ReleaseplannertestPrivateEndpointConnectionResource" /> object. </returns>
        public static ReleaseplannertestPrivateEndpointConnectionResource GetReleaseplannertestPrivateEndpointConnectionResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                ReleaseplannertestPrivateEndpointConnectionResource.ValidateResourceId(id);
                return new ReleaseplannertestPrivateEndpointConnectionResource(client, id);
            }
            );
        }
        #endregion

        #region ReleaseplannertestPrivateLinkResource
        /// <summary>
        /// Gets an object representing a <see cref="ReleaseplannertestPrivateLinkResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="ReleaseplannertestPrivateLinkResource.CreateResourceIdentifier" /> to create a <see cref="ReleaseplannertestPrivateLinkResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="ReleaseplannertestPrivateLinkResource" /> object. </returns>
        public static ReleaseplannertestPrivateLinkResource GetReleaseplannertestPrivateLinkResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                ReleaseplannertestPrivateLinkResource.ValidateResourceId(id);
                return new ReleaseplannertestPrivateLinkResource(client, id);
            }
            );
        }
        #endregion
