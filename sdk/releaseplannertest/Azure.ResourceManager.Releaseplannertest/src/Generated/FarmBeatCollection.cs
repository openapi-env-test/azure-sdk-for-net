...
namespace Azure.ResourceManager.Releaseplannertest
{
    ...
    public partial class FarmBeatCollection : ArmCollection, IEnumerable<FarmBeatResource>, IAsyncEnumerable<FarmBeatResource>
    {
        ...
        internal FarmBeatCollection(ArmClient client, ResourceIdentifier id, Guid subscriptionId, string resourceGroupName) : base(client, id)
        {
            ...
            _farmBeatFarmBeatsModelsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Releaseplannertest", FarmBeatResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<FarmBeatResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string farmBeatsResourceName, FarmBeatData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ReleaseplannertestArmOperation<FarmBeatResource>(Response.FromValue(new FarmBeatResource(Client, response), response.GetRawResponse()));
