...
namespace Azure.ResourceManager.Releaseplannertest
{
    public partial class FarmBeatData : IUtf8JsonSerializable
    {
        ...
        internal static FarmBeatData DeserializeFarmBeatData(JsonElement element)
        {
            ...
            Optional<ReleaseplannertestPrivateEndpointConnectionData> privateEndpointConnections = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("privateEndpointConnections"))
                        {
                            ...
                            privateEndpointConnections = ReleaseplannertestPrivateEndpointConnectionData.DeserializeReleaseplannertestPrivateEndpointConnectionData(property0.Value);
                            continue;
                        }
                    }
                    continue;
