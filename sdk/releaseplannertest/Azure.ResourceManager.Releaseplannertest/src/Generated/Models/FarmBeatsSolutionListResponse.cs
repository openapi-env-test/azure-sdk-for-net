...
namespace Azure.ResourceManager.Releaseplannertest.Models
{
    ...
    {
        /// <summary> Initializes a new instance of FarmBeatsSolutionListResponse. </summary>
        internal FarmBeatsSolutionListResponse()
        {
            Value = new ChangeTrackingList<FarmBeatsSolutionData>();
        }
        ...
        internal FarmBeatsSolutionListResponse(IReadOnlyList<FarmBeatsSolutionData> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<FarmBeatsSolutionData> Value { get; }
