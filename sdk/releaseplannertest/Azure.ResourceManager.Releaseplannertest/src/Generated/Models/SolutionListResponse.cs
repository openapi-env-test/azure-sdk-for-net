...
namespace Azure.ResourceManager.Releaseplannertest.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SolutionListResponse. </summary>
        internal SolutionListResponse()
        {
            Value = new ChangeTrackingList<SolutionData>();
        }
        ...
        internal SolutionListResponse(IReadOnlyList<SolutionData> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
