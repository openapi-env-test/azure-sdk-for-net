...
namespace Azure.ResourceManager.Releaseplannertest.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SolutionProperties. </summary>
        ...
        /// <param name="marketplacePublisherId"> SaaS application Publisher Id. </param>
        ...
        internal SolutionProperties(string solutionId, string partnerId, string saasSubscriptionId, string saasSubscriptionName, string marketplacePublisherId, string planId, string offerId, string termId, IDictionary<string, BinaryData> additionalProperties)
        {
        ...
        /// <summary> SaaS application Publisher Id. </summary>
