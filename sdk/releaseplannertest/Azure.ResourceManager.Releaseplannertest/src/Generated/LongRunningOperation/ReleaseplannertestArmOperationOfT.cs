...
#pragma warning disable SA1649 // File name should match first type name
    internal class ReleaseplannertestArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of ReleaseplannertestArmOperation for mocking. </summary>
        protected ReleaseplannertestArmOperation()
        {
        }

        internal ReleaseplannertestArmOperation(Response<T> response)
        {
            _operation = OperationInternal<T>.Succeeded(response.GetRawResponse(), response.Value);
        }

        internal ReleaseplannertestArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(clientDiagnostics, nextLinkOperation, response, "ReleaseplannertestArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
