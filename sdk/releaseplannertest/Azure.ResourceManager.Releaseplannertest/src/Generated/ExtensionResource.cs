...
namespace Azure.ResourceManager.Releaseplannertest
{
    ...
    public partial class ExtensionResource : ArmResource
    {
        ...
        {
            _extensionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Releaseplannertest", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ExtensionResource>> UpdateAsync(WaitUntil waitUntil, ExtensionCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ReleaseplannertestArmOperation<ExtensionResource>(Response.FromValue(new ExtensionResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
