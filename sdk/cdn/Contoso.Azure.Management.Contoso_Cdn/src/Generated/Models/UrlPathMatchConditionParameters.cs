...
namespace Contoso.Azure.Management.Cdn.Models
{
    ...
    public partial class UrlPathMatchConditionParameters
    {
        ...
        /// 'GreaterThanOrEqual', 'Wildcard', 'RegEx'</param>
        ...
        public UrlPathMatchConditionParameters(string operatorProperty, bool? negateCondition = default(bool?), IList<string> matchValues = default(IList<string>), IList<string> transforms = default(IList<string>))
        {
