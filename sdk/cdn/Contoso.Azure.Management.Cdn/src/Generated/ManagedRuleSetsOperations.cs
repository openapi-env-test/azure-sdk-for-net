    ...
    internal partial class ManagedRuleSetsOperations : IServiceOperations<CdnManagementClient>, IManagedRuleSetsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<ManagedRuleSetDefinition>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ManagedRuleSetDefinition>>(_responseContent, Client.DeserializationSettings);
                }
