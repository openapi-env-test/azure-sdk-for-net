...
namespace Contoso.Azure.Management.Cdn
{
    ...
    /// </summary>
    internal partial class ValidateOperations : IServiceOperations<CdnManagementClient>, IValidateOperations
    {
        /// <summary>
        /// Initializes a new instance of the ValidateOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ValidateOperations(CdnManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<ValidateSecretOutput>> SecretMethodWithHttpMessagesAsync(ResourceReference secretSource, string secretType, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                _requestContent = Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(validateSecretInput, Client.SerializationSettings);
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ValidateSecretOutput>(_responseContent, Client.DeserializationSettings);
                }
