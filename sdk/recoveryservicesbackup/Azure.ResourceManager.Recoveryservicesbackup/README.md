# Azure recoveryservicesbackup Management client library for .NET
...
Install the Azure recoveryservicesbackup management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Recoveryservicesbackup --prerelease
```
