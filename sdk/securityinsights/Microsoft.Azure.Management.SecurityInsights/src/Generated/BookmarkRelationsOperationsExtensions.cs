...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights
{
    ...
    public static partial class BookmarkRelationsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<Relation> List(this IBookmarkRelationsOperations operations, string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string bookmarkId, ODataQuery<Relation> odataQuery = default(ODataQuery<Relation>), string skipToken = default(string))
            {
            ...
            /// </param>
            public static async Task<IPage<Relation>> ListAsync(this IBookmarkRelationsOperations operations, string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string bookmarkId, ODataQuery<Relation> odataQuery = default(ODataQuery<Relation>), string skipToken = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
