...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights
{
    ...
    internal partial class DataConnectorsCheckRequirementsOperations : IServiceOperations<SecurityInsightsClient>, IDataConnectorsCheckRequirementsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<DataConnectorRequirementsState>> PostWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string operationalInsightsResourceProvider, DataConnectorsCheckRequirements dataConnectorsCheckRequirements, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
