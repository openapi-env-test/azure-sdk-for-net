...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights
{
    ...
    public partial interface IIncidentRelationsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Relation>> CreateOrUpdateRelationWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string incidentId, string relationName, string relatedResourceId, string etag = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
