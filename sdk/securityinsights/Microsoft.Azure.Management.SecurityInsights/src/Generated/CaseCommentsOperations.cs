...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights
{
    ...
    /// </summary>
    internal partial class CaseCommentsOperations : IServiceOperations<SecurityInsightsClient>, ICaseCommentsOperations
    {
        /// <summary>
        /// Initializes a new instance of the CaseCommentsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal CaseCommentsOperations(SecurityInsightsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<CaseComment>> CreateCommentWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string caseId, string caseCommentId, string message, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("caseComment", caseComment);
            ...
            if(caseComment != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(caseComment, Client.SerializationSettings);
