...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights
{
    ...
    public partial interface IThreatIntelligenceIndicatorsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<ThreatIntelligenceInformation>>> ListWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string filter = default(string), int? top = default(int?), string skipToken = default(string), string orderby = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get all threat intelligence indicators.
        /// </summary>
