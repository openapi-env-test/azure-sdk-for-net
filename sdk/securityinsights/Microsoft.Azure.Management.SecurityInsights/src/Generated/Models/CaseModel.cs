...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    public partial class CaseModel : ResourceWithEtag
    {
        ...
        /// identifiers</param>
        /// <param name="tactics">The tactics associated with case</param>
        /// <param name="totalComments">the number of total comments in the
        /// case</param>
        public CaseModel(string severity, System.DateTime startTimeUtc, string status, string title, string id = default(string), string name = default(string), string type = default(string), string etag = default(string), int? caseNumber = default(int?), string closeReason = default(string), string closedReasonText = default(string), System.DateTime? createdTimeUtc = default(System.DateTime?), string description = default(string), System.DateTime? endTimeUtc = default(System.DateTime?), IList<string> labels = default(IList<string>), string lastComment = default(string), System.DateTime? lastUpdatedTimeUtc = default(System.DateTime?), UserInfo owner = default(UserInfo), IList<string> relatedAlertIds = default(IList<string>), IList<string> tactics = default(IList<string>), int? totalComments = default(int?))
        ...
        /// <summary>
        /// Gets the tactics associated with case
        /// </summary>
