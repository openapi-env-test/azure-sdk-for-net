...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    public partial class InsightQueryItem : EntityQueryItem
    {
        ...
        public InsightQueryItem(System.Guid? id = default(System.Guid?), string name = default(string), string type = default(string), InsightQueryItemProperties properties = default(InsightQueryItemProperties))
            : base(id, name, type)
        {
