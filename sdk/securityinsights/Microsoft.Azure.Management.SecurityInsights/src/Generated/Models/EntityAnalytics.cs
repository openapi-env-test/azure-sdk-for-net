...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("EntityAnalytics")]
    ...
    public partial class EntityAnalytics : Settings
    {
        ...
        /// disabled.</param>
        public EntityAnalytics(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), bool? isEnabled = default(bool?))
