...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("ThreatIntelligenceInformation")]
    public partial class ThreatIntelligenceInformation
    {
        ...
        public ThreatIntelligenceInformation(string id = default(string), string name = default(string), string type = default(string), string etag = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
