...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    public partial class AzureResourceEntity : Entity
    {
        ...
        /// resource</param>
        public AzureResourceEntity(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, object> additionalData = default(IDictionary<string, object>), string friendlyName = default(string), string resourceId = default(string), string subscriptionId = default(string))
            : base(id, name, type)
        {
