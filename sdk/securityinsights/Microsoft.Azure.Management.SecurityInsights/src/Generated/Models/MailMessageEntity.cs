...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    public partial class MailMessageEntity : Entity
    {
        ...
        /// <param name="receivedDate">The received date of this
        /// message</param>
        ...
        public MailMessageEntity(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, object> additionalData = default(IDictionary<string, object>), string friendlyName = default(string), IList<string> fileEntityIds = default(IList<string>), string recipient = default(string), string urls = default(string), IList<string> threats = default(IList<string>), string p1Sender = default(string), string p1SenderDisplayName = default(string), string p1SenderDomain = default(string), string senderIP = default(string), string p2Sender = default(string), string p2SenderDisplayName = default(string), string p2SenderDomain = default(string), System.DateTime? receivedDate = default(System.DateTime?), System.Guid? networkMessageId = default(System.Guid?), string internetMessageId = default(string), string subject = default(string), string language = default(string), string threatDetectionMethods = default(string), int? bodyFingerprintBin1 = default(int?), int? bodyFingerprintBin2 = default(int?), int? bodyFingerprintBin3 = default(int?), int? bodyFingerprintBin4 = default(int?), int? bodyFingerprintBin5 = default(int?), string antispamDirection = default(string), DeliveryAction? deliveryAction = default(DeliveryAction?), DeliveryLocation? deliveryLocation = default(DeliveryLocation?))
            : base(id, name, type)
        {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.receivedDate")]
        public System.DateTime? ReceivedDate { get; private set; }
        ...
        public string ThreatDetectionMethods { get; private set; }
