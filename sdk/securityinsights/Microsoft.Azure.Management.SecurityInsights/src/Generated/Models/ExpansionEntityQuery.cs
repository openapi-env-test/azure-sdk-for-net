...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    public partial class ExpansionEntityQuery : EntityQuery
    {
        ...
        /// and formatted</param>
        public ExpansionEntityQuery(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), IList<string> dataSources = default(IList<string>), string displayName = default(string), string inputEntityType = default(string), IList<string> inputFields = default(IList<string>), IList<string> outputEntityTypes = default(IList<string>), string queryTemplate = default(string))
