...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights.Models
{
    ...
    public partial class FileEntity : Entity
    {
        ...
        /// belongs to</param>
        public FileEntity(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, object> additionalData = default(IDictionary<string, object>), string friendlyName = default(string), string directory = default(string), IList<string> fileHashEntityIds = default(IList<string>), string fileName = default(string), string hostEntityId = default(string))
            : base(id, name, type)
        {
