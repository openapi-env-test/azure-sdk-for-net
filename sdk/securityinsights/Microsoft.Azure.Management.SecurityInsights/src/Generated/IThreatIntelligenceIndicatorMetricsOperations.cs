...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights
{
    ...
    public partial interface IThreatIntelligenceIndicatorMetricsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<ThreatIntelligenceMetricsList>> ListWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
