...
namespace Microsoft.Azure.Contoso.Management.SecurityInsights
{
    ...
    /// </summary>
    internal partial class ThreatIntelligenceIndicatorMetricsOperations : IServiceOperations<SecurityInsightsClient>, IThreatIntelligenceIndicatorMetricsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ThreatIntelligenceIndicatorMetricsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ThreatIntelligenceIndicatorMetricsOperations(SecurityInsightsClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ThreatIntelligenceMetricsList>> ListWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/threatIntelligence/main/metrics").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<ThreatIntelligenceMetricsList>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ThreatIntelligenceMetricsList>(_responseContent, Client.DeserializationSettings);
                }
