...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class FactoriesOperationsExtensions
    {
            ...
            /// </param>
            public static Factory ConfigureFactoryRepoForDemo(this IFactoriesOperations operations, string locationId, FactoryRepoUpdate factoryRepoUpdate)
            {
                return operations.ConfigureFactoryRepoForDemoAsync(locationId, factoryRepoUpdate).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Factory> ConfigureFactoryRepoForDemoAsync(this IFactoriesOperations operations, string locationId, FactoryRepoUpdate factoryRepoUpdate, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ConfigureFactoryRepoForDemoWithHttpMessagesAsync(locationId, factoryRepoUpdate, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
