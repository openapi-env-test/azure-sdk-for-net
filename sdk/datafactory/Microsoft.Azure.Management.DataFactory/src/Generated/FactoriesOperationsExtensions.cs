...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    public static partial class FactoriesOperationsExtensions
    {
            ...
            /// Get GitHub access token request definition.
            /// </param>
            public static GitHubAccessTokenResponse GetGitHubAccessTokenDemo(this IFactoriesOperations operations, string resourceGroupName, string factoryName, GitHubAccessTokenRequest gitHubAccessTokenRequest)
            {
                return operations.GetGitHubAccessTokenDemoAsync(resourceGroupName, factoryName, gitHubAccessTokenRequest).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<GitHubAccessTokenResponse> GetGitHubAccessTokenDemoAsync(this IFactoriesOperations operations, string resourceGroupName, string factoryName, GitHubAccessTokenRequest gitHubAccessTokenRequest, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetGitHubAccessTokenDemoWithHttpMessagesAsync(resourceGroupName, factoryName, gitHubAccessTokenRequest, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
