...
namespace Microsoft.Azure.Management.AppConfiguration
{
    ...
    public static partial class ConfigurationStoresOperationsExtensions
    {
            ...
            /// parameter that specifies a starting point to use for subsequent calls.
            /// </param>
            public static ErrorResponse ListByResourceGroup(this IConfigurationStoresOperations operations, string resourceGroupName, string skipToken = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ErrorResponse> ListByResourceGroupAsync(this IConfigurationStoresOperations operations, string resourceGroupName, string skipToken = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ErrorResponse GetABCDEF(this IConfigurationStoresOperations operations, string resourceGroupName, string configStoreName)
            {
                return operations.GetABCDEFAsync(resourceGroupName, configStoreName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ErrorResponse> GetABCDEFAsync(this IConfigurationStoresOperations operations, string resourceGroupName, string configStoreName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetABCDEFWithHttpMessagesAsync(resourceGroupName, configStoreName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static ErrorResponse ListByResourceGroupNext(this IConfigurationStoresOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ErrorResponse> ListByResourceGroupNextAsync(this IConfigurationStoresOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
