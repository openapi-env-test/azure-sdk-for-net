...
namespace Microsoft.Azure.Management.AppConfiguration
{
    ...
    public static partial class ConfigurationStoresOperationsExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static IPage<DeletedConfigurationStore> ListDeleted(this IConfigurationStoresOperations operations)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<DeletedConfigurationStore>> ListDeletedAsync(this IConfigurationStoresOperations operations, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The name of the configuration store.
            /// </param>
            public static DeletedConfigurationStore GetDeleted(this IConfigurationStoresOperations operations, string location, string configStoreName)
            {
                return operations.GetDeletedAsync(location, configStoreName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DeletedConfigurationStore> GetDeletedAsync(this IConfigurationStoresOperations operations, string location, string configStoreName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetDeletedWithHttpMessagesAsync(location, configStoreName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The name of the configuration store.
            /// </param>
            public static void PurgeDeleted(this IConfigurationStoresOperations operations, string location, string configStoreName)
            {
                operations.PurgeDeletedAsync(location, configStoreName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task PurgeDeletedAsync(this IConfigurationStoresOperations operations, string location, string configStoreName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.PurgeDeletedWithHttpMessagesAsync(location, configStoreName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// The name of the configuration store.
            /// </param>
            public static void BeginPurgeDeleted(this IConfigurationStoresOperations operations, string location, string configStoreName)
            {
                operations.BeginPurgeDeletedAsync(location, configStoreName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginPurgeDeletedAsync(this IConfigurationStoresOperations operations, string location, string configStoreName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginPurgeDeletedWithHttpMessagesAsync(location, configStoreName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<DeletedConfigurationStore> ListDeletedNext(this IConfigurationStoresOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<DeletedConfigurationStore>> ListDeletedNextAsync(this IConfigurationStoresOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
