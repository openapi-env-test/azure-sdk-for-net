...
namespace Microsoft.Azure.Management.AppConfiguration
{
    ...
    public static partial class OperationsExtensions
    {
            ...
            /// The name to check for availability.
            /// </param>
            public static NameAvailabilityStatus RegionalCheckNameAvailability(this IOperations operations, string location, string name)
            {
                return operations.RegionalCheckNameAvailabilityAsync(location, name).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NameAvailabilityStatus> RegionalCheckNameAvailabilityAsync(this IOperations operations, string location, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RegionalCheckNameAvailabilityWithHttpMessagesAsync(location, name, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
