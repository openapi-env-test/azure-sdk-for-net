...
namespace Microsoft.Azure.Management.AppConfiguration.Models
{
    ...
    public partial class ConfigurationStoreUpdateParameters
    {
        ...
        public ConfigurationStoreUpdateParameters(EncryptionProperties encryption = default(EncryptionProperties), bool? disableLocalAuth = default(bool?), string publicNetworkAccess = default(string), bool? enablePurgeProtection = default(bool?), ResourceIdentity identity = default(ResourceIdentity), Sku sku = default(Sku), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
