...
namespace Microsoft.Azure.Management.Advisor.Models
{
    ...
    public partial class DigestConfig
    {
        ...
        /// (en).</param>
        public DigestConfig(string actionGroupResourceId = default(string), System.DateTime? frequency = default(System.DateTime?), IList<string> categories = default(IList<string>), string language = default(string))
        {
        ...
        public System.DateTime? Frequency { get; set; }
