...
{
    public partial class DemoNewServiceClientOptions : Azure.Core.ClientOptions
    {
        public DemoNewServiceClientOptions(Azure.IoT.NewServicesDemo.DemoNewServiceClientOptions.ServiceVersion version = Azure.IoT.NewServicesDemo.DemoNewServiceClientOptions.ServiceVersion.V2022_07_01_preview) { }
    ...
    public partial class DeviceManagementClient
    {
        ...
        public DeviceManagementClient(string endpoint, string instanceId, Azure.Core.TokenCredential credential, Azure.IoT.NewServicesDemo.DemoNewServiceClientOptions options) { }
    ...
    public partial class DeviceUpdateClient
    {
        ...
        public DeviceUpdateClient(string endpoint, string instanceId, Azure.Core.TokenCredential credential, Azure.IoT.NewServicesDemo.DemoNewServiceClientOptions options) { }
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
