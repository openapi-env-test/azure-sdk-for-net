...
namespace Azure.IoT.NewServicesDemo
{
    ...
    public partial class DeviceUpdateClient
    {
        ...
        public DeviceUpdateClient(string endpoint, string instanceId, TokenCredential credential) : this(endpoint, instanceId, credential, new DemoNewServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/>, <paramref name="instanceId"/> or <paramref name="credential"/> is null. </exception>
        public DeviceUpdateClient(string endpoint, string instanceId, TokenCredential credential, DemoNewServiceClientOptions options)
        {
