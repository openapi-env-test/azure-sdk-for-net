namespace Azure.IoT.NewServiceDemo
{
    ...
    {
        public DemoNewServiceClientOptions(Azure.IoT.NewServiceDemo.DemoNewServiceClientOptions.ServiceVersion version = Azure.IoT.NewServiceDemo.DemoNewServiceClientOptions.ServiceVersion.V2022_07_01_preview) { }
    ...
    public partial class DeviceManagementClient
    {
        ...
        public DeviceManagementClient(string endpoint, string instanceId, Azure.Core.TokenCredential credential, Azure.IoT.NewServiceDemo.DemoNewServiceClientOptions options) { }
    ...
    public partial class DeviceUpdateClient
    {
        ...
        public DeviceUpdateClient(string endpoint, string instanceId, Azure.Core.TokenCredential credential, Azure.IoT.NewServiceDemo.DemoNewServiceClientOptions options) { }
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
