...
namespace Azure.ResourceManager.Iothub.Models
{
    ...
    public partial class RoutingEndpoints
    {
        ...
        public RoutingEndpoints()
        {
            ...
            CosmosDBSqlCollections = new ChangeTrackingList<RoutingCosmosDBSqlApiProperties>();
        }
        ...
        /// <param name="cosmosDBSqlCollections"> The list of Cosmos DB collection endpoints that IoT hub routes messages to, based on the routing rules. </param>
        internal RoutingEndpoints(IList<RoutingServiceBusQueueEndpointProperties> serviceBusQueues, IList<RoutingServiceBusTopicEndpointProperties> serviceBusTopics, IList<RoutingEventHubProperties> eventHubs, IList<RoutingStorageContainerProperties> storageContainers, IList<RoutingCosmosDBSqlApiProperties> cosmosDBSqlCollections)
        {
        ...
        /// <summary> The list of Cosmos DB collection endpoints that IoT hub routes messages to, based on the routing rules. </summary>
        public IList<RoutingCosmosDBSqlApiProperties> CosmosDBSqlCollections { get; }
    }
}
