...
namespace Azure.ResourceManager.Iothub.Models
{
    public partial class RoutingEndpoints : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsCollectionDefined(AzureDigitalTwinsInstances))
            {
                writer.WritePropertyName("azureDigitalTwinsInstances");
                writer.WriteStartArray();
                foreach (var item in AzureDigitalTwinsInstances)
                {
        ...
        {
            Optional<IList<RoutingAzureDigitalTwinsEndpointProperties>> azureDigitalTwinsInstances = default;
            ...
            {
                if (property.NameEquals("azureDigitalTwinsInstances"))
                {
                    ...
                    List<RoutingAzureDigitalTwinsEndpointProperties> array = new List<RoutingAzureDigitalTwinsEndpointProperties>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(RoutingAzureDigitalTwinsEndpointProperties.DeserializeRoutingAzureDigitalTwinsEndpointProperties(item));
                    }
                    azureDigitalTwinsInstances = array;
                    continue;
                }
            ...
            return new RoutingEndpoints(Optional.ToList(azureDigitalTwinsInstances), Optional.ToList(serviceBusQueues), Optional.ToList(serviceBusTopics), Optional.ToList(eventHubs), Optional.ToList(storageContainers));
        }
    }
}
