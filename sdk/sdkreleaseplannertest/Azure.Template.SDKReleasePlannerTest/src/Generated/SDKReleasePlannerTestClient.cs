...
{
    // Data plane generated client. The SDKReleasePlannerTest service client.
    /// <summary> The SDKReleasePlannerTest service client. </summary>
    public partial class SDKReleasePlannerTestClient
    {
        ...
        /// <summary> Initializes a new instance of SDKReleasePlannerTestClient for mocking. </summary>
        protected SDKReleasePlannerTestClient()
        {
        }

        /// <summary> Initializes a new instance of SDKReleasePlannerTestClient. </summary>
        /// <param name="endpoint"> The Uri to use. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public SDKReleasePlannerTestClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new SDKReleasePlannerTestClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public SDKReleasePlannerTestClient(Uri endpoint, TokenCredential credential, SDKReleasePlannerTestClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new SDKReleasePlannerTestClientOptions();
        ...
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetCollectionsAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetCollectionsAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetCollections");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetCollections(RequestContext)']/*" />
        ...
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetEnclaveQuotesAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetEnclaveQuotesAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetEnclaveQuotes");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetEnclaveQuotes(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetConstitutionAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetConstitutionAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetConstitution");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetConstitution(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetConsortiumMembersAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetConsortiumMembersAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetConsortiumMembers");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetConsortiumMembers(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='CreateLedgerEntryAsync(RequestContent,String,RequestContext)']/*" />
        public virtual async Task<Response> CreateLedgerEntryAsync(RequestContent content, string collectionId = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.CreateLedgerEntry");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='CreateLedgerEntry(RequestContent,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetLedgerEntryAsync(String,String,RequestContext)']/*" />
        public virtual async Task<Response> GetLedgerEntryAsync(string transactionId, string collectionId = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetLedgerEntry");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetLedgerEntry(String,String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetReceiptAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetReceiptAsync(string transactionId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(transactionId, nameof(transactionId));

            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetReceipt");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetReceipt(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetTransactionStatusAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetTransactionStatusAsync(string transactionId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(transactionId, nameof(transactionId));

            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetTransactionStatus");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetTransactionStatus(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetCurrentLedgerEntryAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetCurrentLedgerEntryAsync(string collectionId = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetCurrentLedgerEntry");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetCurrentLedgerEntry(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='DeleteUserAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> DeleteUserAsync(string userId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(userId, nameof(userId));

            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.DeleteUser");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='DeleteUser(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetUserAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetUserAsync(string userId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(userId, nameof(userId));

            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.GetUser");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetUser(String,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='CreateOrUpdateUserAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateOrUpdateUserAsync(string userId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SDKReleasePlannerTestClient.CreateOrUpdateUser");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='CreateOrUpdateUser(String,RequestContent,RequestContext)']/*" />
        ...
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetLedgerEntriesAsync(RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetLedgerEntriesAsync(RequestContext context = null)
        {
            return GetLedgerEntriesImplementationAsync("SDKReleasePlannerTestClient.GetLedgerEntries", context);
        }
        ...
        /// <include file="Docs/SDKReleasePlannerTestClient.xml" path="doc/members/member[@name='GetLedgerEntries(RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetLedgerEntries(RequestContext context = null)
        {
            return GetLedgerEntriesImplementation("SDKReleasePlannerTestClient.GetLedgerEntries", context);
        }
